...
- **综合**
  - [数据结构和算法指南](docs/01.计算机科学/01.数据结构和算法/00.综合/01.数据结构和算法指南.md)
  - [复杂度分析](docs/01.计算机科学/01.数据结构和算法/00.综合/02.复杂度分析.md) - 关键词：**`时间复杂度`**、**`空间复杂度`**、**`大 O 表示法`**、**`复杂度量级`**
- **线性表**
  - [数组和链表](docs/01.计算机科学/01.数据结构和算法/01.线性表/01.数组和链表.md) - 关键词：**`线性表`**、**`一维数组`**、**`多维数组`**、**`随机访问`**、**`单链表`**、**`双链表`**、**`循环链表`**
  - [栈和队列](docs/01.计算机科学/01.数据结构和算法/01.线性表/02.栈和队列.md) - 关键词：**`先进后出`**、**`后进先出`**、**`循环队列`**
  - [线性表的查找](docs/01.计算机科学/01.数据结构和算法/01.线性表/11.线性表的查找.md)
  - [线性表的排序](docs/01.计算机科学/01.数据结构和算法/01.线性表/12.线性表的排序.md)
- **树**
  - [树和二叉树](docs/01.计算机科学/01.数据结构和算法/02.树/01.树和二叉树.md)
  - [堆](docs/01.计算机科学/01.数据结构和算法/02.树/02.堆.md)
  - [B+树](docs/01.计算机科学/01.数据结构和算法/02.树/03.B+树.md)
  - [LSM 树](docs/01.计算机科学/01.数据结构和算法/02.树/04.LSM树.md)
  - [字典树](docs/01.计算机科学/01.数据结构和算法/02.树/05.字典树.md)
  - [红黑树](docs/01.计算机科学/01.数据结构和算法/02.树/06.红黑树.md)
- [哈希表](docs/01.计算机科学/01.数据结构和算法/03.哈希表.md) - 关键词：**`哈希函数`**、**`装载因子`**、**`哈希冲突`**、**`开放寻址法`**、**`拉链法`**
- [跳表](docs/01.计算机科学/01.数据结构和算法/04.跳表.md) - 关键词：**`多级索引`**
- [图](docs/01.计算机科学/01.数据结构和算法/05.图.md)
...
- [计算机网络面试总结](docs/01.计算机科学/03.网络/01.网络综合/01.计算机网络面试.md)
- [计算机网络指南](docs/01.计算机科学/03.网络/01.网络综合/02.计算机网络指南.md) - 关键词：核心概念、拓扑结构、作用范围、性能指标、体系结构
- **网络分层**
  - [计算机网络之物理层](docs/01.计算机科学/03.网络/01.网络综合/11.物理层.md) - 关键词：调制、解调、数字信号、模拟信号、通信媒介、信道复用
  - [计算机网络之数据链路层](docs/01.计算机科学/03.网络/01.网络综合/12.数据链路层.md) - 关键词：点对点信道、广播信道、`PPP`、`CSMA/CD`、局域网、以太网、`MAC`、适配器、集线器、网桥、交换机
  - [计算机网络之网络层](docs/01.计算机科学/03.网络/01.网络综合/13.网络层.md) - 关键词：`IP`、`ICMP`、`ARP`、路由
  - [计算机网络之传输层](docs/01.计算机科学/03.网络/01.网络综合/14.传输层.md) - 关键词：`UDP`、`TCP`、滑动窗口、拥塞控制、三次握手
  - [计算机网络之应用层](docs/01.计算机科学/03.网络/01.网络综合/15.应用层.md) - 关键词：`HTTP`、`DNS`、`FTP`、`TELNET`、`DHCP`

#### 网络协议

- [超文本传输协议 HTTP](docs/01.计算机科学/03.网络/02.网络协议/01.HTTP.md)
- [域名系统协议 DNS](docs/01.计算机科学/03.网络/02.网络协议/02.DNS)
- [传输控制协议 TCP](docs/01.计算机科学/03.网络/02.网络协议/03.TCP.md)
- [用户数据报协议 UDP](docs/01.计算机科学/03.网络/02.网络协议/04.UDP.md)
- [ICMP](docs/01.计算机科学/03.网络/02.网络协议/05.ICMP.md)

#### 网络技术

- [WebSocket](docs/01.计算机科学/03.网络/03.网络技术/01.WebSocket.md)
- [CDN](docs/01.计算机科学/03.网络/03.网络技术/02.CDN.md)
- [VPN](docs/01.计算机科学/03.网络/03.网络技术/03.VPN.md)

### 分布式

#### 分布式综合

- [分布式面试总结](docs/01.计算机科学/11.分布式/01.分布式综合/01.分布式面试.md)

#### 分布式理论

- [分布式理论](docs/01.计算机科学/11.分布式/02.分布式理论/01.分布式理论.md) - 关键词：`拜占庭将军`、`CAP`、`BASE`、`错误的分布式假设`
- [分布式算法 Paxos](docs/01.计算机科学/11.分布式/02.分布式理论/02.分布式算法Paxos.md) - 关键词：`共识性算法`
- [分布式算法 Raft](docs/01.计算机科学/11.分布式/02.分布式理论/03.分布式算法Raft.md) - 关键词：`共识性算法`
- [分布式算法 Gossip](docs/01.计算机科学/11.分布式/02.分布式理论/04.分布式算法Gossip.md) - 关键词：`数据传播`
...
- [流量控制](docs/01.计算机科学/11.分布式/03.分布式关键技术/01.流量调度/01.流量控制.md) - 关键词：`限流`、`熔断`、`降级`、`计数器法`、`时间窗口法`、`令牌桶法`、`漏桶法`
- [负载均衡](docs/01.计算机科学/11.分布式/03.分布式关键技术/01.流量调度/02.负载均衡.md) - 关键词：`轮询`、`随机`、`最少连接`、`源地址哈希`、`一致性哈希`、`虚拟 hash 槽`
- [服务路由](docs/01.计算机科学/11.分布式/03.分布式关键技术/01.流量调度/03.服务路由.md) - 关键词：`路由`、`条件路由`、`脚本路由`、`标签路由`
- 服务网关
- [分布式会话](docs/01.计算机科学/11.分布式/03.分布式关键技术/01.流量调度/10.分布式会话.md) - 关键词：`粘性 Session`、`Session 复制共享`、`基于缓存的 session 共享`

##### 数据调度

- [数据缓存](docs/01.计算机科学/11.分布式/03.分布式关键技术/02.数据调度/01.数据缓存.md) - 关键词：`进程内缓存`、`分布式缓存`、`缓存雪崩`、`缓存穿透`、`缓存击穿`、`缓存更新`、`缓存预热`、`缓存降级`
- [读写分离](docs/01.计算机科学/11.分布式/03.分布式关键技术/02.数据调度/02.读写分离.md)
- [分库分表](docs/01.计算机科学/11.分布式/03.分布式关键技术/02.数据调度/03.分库分表.md) - 关键词：`分片`、`路由`、`迁移`、`扩容`、`双写`、`聚合`
- [分布式 ID](docs/01.计算机科学/11.分布式/03.分布式关键技术/02.数据调度/04.分布式ID.md) - 关键词：`UUID`、`自增序列`、`雪花算法`、`Leaf`
- [分布式事务](docs/01.计算机科学/11.分布式/03.分布式关键技术/02.数据调度/05.分布式事务.md) - 关键词：`2PC`、`3PC`、`TCC`、`本地消息表`、`MQ 消息`、`SAGA`
- [分布式锁](docs/01.计算机科学/11.分布式/03.分布式关键技术/02.数据调度/06.分布式锁.md) - 关键词：`数据库`、`Redis`、`ZooKeeper`、`互斥`、`可重入`、`死锁`、`容错`、`自旋尝试`
...
- [消息队列](docs/01.计算机科学/11.分布式/03.分布式关键技术/04.通信/01.消息队列.md) - 关键词：`重复消费`、`消息丢失`、`消息顺序性`、`消息积压`

##### 服务治理

- [服务注册和发现](docs/01.计算机科学/11.分布式/03.分布式关键技术/05.服务治理/01.服务注册和发现.md)
- [服务监控](docs/01.计算机科学/11.分布式/03.分布式关键技术/05.服务治理/02.服务监控.md)
- [服务链路监控](docs/01.计算机科学/11.分布式/03.分布式关键技术/05.服务治理/03.服务链路监控.md)
- [服务容错](docs/01.计算机科学/11.分布式/03.分布式关键技术/05.服务治理/04.服务容错.md)
- 服务编排
- 服务版本管理
- 流量调度
  - [流量控制](docs/01.计算机科学/11.分布式/03.分布式关键技术/01.流量调度/01.流量控制.md) - 关键词：`限流`、`熔断`、`降级`、`计数器法`、`时间窗口法`、`令牌桶法`、`漏桶法`
...
- [JavaWeb 面经](docs/02.编程/03.Java/02.JavaEE/01.JavaWeb/99.JavaWeb面经.md)
- [JavaWeb 之 Servlet 指南](docs/02.编程/03.Java/02.JavaEE/01.JavaWeb/01.JavaWeb之Servlet指南.md)
- [JavaWeb 之 Jsp 指南](docs/02.编程/03.Java/02.JavaEE/01.JavaWeb/02.JavaWeb之Jsp指南.md)
- [JavaWeb 之 Filter 和 Listener](docs/02.编程/03.Java/02.JavaEE/01.JavaWeb/03.JavaWeb之Filter和Listener.md)
- [JavaWeb 之 Cookie 和 Session](docs/02.编程/03.Java/02.JavaEE/01.JavaWeb/04.JavaWeb之Cookie和Session.md)
...
- [Tomcat 快速入门](docs/02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/01.Tomcat快速入门.md)
- [Tomcat 连接器](docs/02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/02.Tomcat连接器.md)
- [Tomcat 容器](docs/02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/03.Tomcat容器.md)
- [Tomcat 优化](docs/02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/04.Tomcat优化.md)
- [Tomcat 和 Jetty](docs/02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/05.Tomcat和Jetty.md)
- [Jetty](docs/02.编程/03.Java/02.JavaEE/02.服务器/02.Jetty.md)

#### Java 软件

##### Java 构建

> Java 项目需要通过 [**构建工具**](docs/02.编程/03.Java/11.软件/01.构建) 来管理项目依赖，完成编译、打包、发布、生成 JavaDoc 等任务。
>
> - 目前最主流的构建工具是 Maven，它的功能非常强大。
> - Gradle 号称是要替代 Maven 等构件工具，它的版本管理确实简洁，但是需要学习 Groovy，学习成本比 Maven 高。
> - Ant 功能比 Maven 和 Gradle 要弱，现代 Java 项目基本不用了，但也有一些传统的 Java 项目还在使用。

- [Maven](docs/02.编程/03.Java/11.软件/01.构建/01.Maven) 📚
  - [Maven 快速入门](docs/02.编程/03.Java/11.软件/01.构建/01.Maven/01.Maven快速入门.md)
  - [Maven 教程之 pom.xml 详解](docs/02.编程/03.Java/11.软件/01.构建/01.Maven/02.Maven教程之pom.xml详解.md)
  - [Maven 教程之 settings.xml 详解](docs/02.编程/03.Java/11.软件/01.构建/01.Maven/03.Maven教程之settings.xml详解.md)
  - [Maven 实战问题和最佳实践](docs/02.编程/03.Java/11.软件/01.构建/01.Maven/04.Maven实战问题和最佳实践.md)
  - [Maven 教程之发布 jar 到私服或中央仓库](docs/02.编程/03.Java/11.软件/01.构建/01.Maven/05.Maven教程之发布jar到私服或中央仓库.md)
  - [Maven 插件之代码检查](docs/02.编程/03.Java/11.软件/01.构建/01.Maven/06.Maven插件之代码检查.md)
- [Ant 简易教程](docs/02.编程/03.Java/11.软件/01.构建/02.Ant.md)

##### Java IDE

> 自从有了 [**IDE**](docs/02.编程/03.Java/11.软件/02.IDE)，写代码从此就告别了刀耕火种的蛮荒时代。
>
> - [Eclipse](docs/02.编程/03.Java/11.软件/02.IDE/02.Eclipse.md) 是久负盛名的开源 Java IDE，我的学生时代一直使用它写 Java。
> - 曾经抗拒从转 [Intellij Idea](docs/02.编程/03.Java/11.软件/02.IDE/01.Intellij.md) ，但后来发现真香，不得不说，确实是目前最优秀的 Java IDE。
> - 你可以在 [vscode](docs/02.编程/03.Java/11.软件/02.IDE/03.VsCode.md) 中写各种语言，只要安装相应插件即可。如果你的项目中使用了很多种编程语言，又懒得在多个 IDE 之间切换，那么就用 vscode 来一网打尽吧。

- [Intellij Idea](docs/02.编程/03.Java/11.软件/02.IDE/01.Intellij.md)
- [Eclipse](docs/02.编程/03.Java/11.软件/02.IDE/02.Eclipse.md)
- [vscode](docs/02.编程/03.Java/11.软件/02.IDE/03.VsCode.md)

##### Java 监控诊断

> [监控/诊断](docs/02.编程/03.Java/11.软件/03.监控诊断) 工具主要用于 Java 应用的运维。通过采集、分析、存储、可视化应用的有效数据，帮助开发者、使用者快速定位问题，找到性能瓶颈。

- [监控工具对比](docs/02.编程/03.Java/11.软件/03.监控诊断/01.监控工具对比.md)
- [CAT](docs/02.编程/03.Java/11.软件/03.监控诊断/02.CAT.md)
- [Zipkin](docs/02.编程/03.Java/11.软件/03.监控诊断/03.Zipkin.md)
- [SkyWalking](docs/02.编程/03.Java/11.软件/03.监控诊断/04.Skywalking.md)
- [Arthas](docs/02.编程/03.Java/11.软件/03.监控诊断/05.Arthas.md)

#### Java 工具

##### Java IO

- [JSON 序列化](docs/02.编程/03.Java/12.工具/01.IO/01.JSON序列化.md) - [fastjson](https://github.com/alibaba/fastjson)、[Jackson](https://github.com/FasterXML/jackson)、[Gson](https://github.com/google/gson)
- [二进制序列化](docs/02.编程/03.Java/12.工具/01.IO/02.二进制序列化.md) - [Protobuf](https://developers.google.com/protocol-buffers)、[Thrift](https://thrift.apache.org/)、[Hessian](docs/02.编程/http://hessian.caucho.com/)、[Kryo](https://github.com/EsotericSoftware/kryo)、[FST](https://github.com/RuedigerMoeller/fast-serialization)

##### JavaBean 工具

- [Lombok](docs/02.编程/03.Java/12.工具/02.JavaBean/01.Lombok.md)
- [Dozer](docs/02.编程/03.Java/12.工具/02.JavaBean/02.Dozer.md)

##### Java 模板引擎

- [Freemark](docs/02.编程/03.Java/12.工具/03.模板引擎/01.Freemark.md)
- [Velocity](docs/02.编程/03.Java/12.工具/03.模板引擎/02.Thymeleaf.md)
- [Thymeleaf](docs/02.编程/03.Java/12.工具/03.模板引擎/03.Velocity.md)

##### Java 测试工具

- [Junit](docs/02.编程/03.Java/12.工具/04.测试/01.Junit.md)
- [Mockito](docs/02.编程/03.Java/12.工具/04.测试/02.Mockito.md)
- [Jmeter](docs/02.编程/03.Java/12.工具/04.测试/03.Jmeter.md)
- [JMH](docs/02.编程/03.Java/12.工具/04.测试/04.JMH.md)

##### 其他

- [Java 日志](docs/02.编程/03.Java/12.工具/99.其他/01.Java日志.md)
- [Java 工具包](docs/02.编程/03.Java/12.工具/99.其他/02.Java工具包.md)
- [Reflections](docs/02.编程/03.Java/12.工具/99.其他/03.Reflections.md)
- [JavaMail](docs/02.编程/03.Java/12.工具/99.其他/04.JavaMail.md)
- [Jsoup](docs/02.编程/03.Java/12.工具/99.其他/05.Jsoup.md)
- [Thumbnailator](docs/02.编程/03.Java/12.工具/99.其他/06.Thumbnailator.md)
- [Zxing](docs/02.编程/03.Java/12.工具/99.其他/07.Zxing.md)

#### Java 框架

##### ORM

- [Mybatis 快速入门](docs/02.编程/03.Java/13.框架/11.ORM/01.Mybatis快速入门.md)
- [Mybatis 原理](docs/02.编程/03.Java/13.框架/11.ORM/02.Mybatis原理.md)
...
- [Shiro](docs/02.编程/03.Java/13.框架/12.安全/01.Shiro.md)
- [SpringSecurity](docs/02.编程/03.Java/13.框架/12.安全/02.SpringSecurity.md)

##### IO

- [Shiro](docs/02.编程/03.Java/13.框架/13.IO/01.Netty.md)

##### 微服务

- [Dubbo](docs/02.编程/03.Java/13.框架/14.微服务/01.Dubbo.md)
...
- [消息队列面试](docs/02.编程/03.Java/14.中间件/01.MQ/01.消息队列面试.md)
- [消息队列基本原理](docs/02.编程/03.Java/14.中间件/01.MQ/02.消息队列基本原理.md)
- [RocketMQ](docs/02.编程/03.Java/14.中间件/01.MQ/03.RocketMQ.md)
- [ActiveMQ](docs/02.编程/03.Java/14.中间件/01.MQ/04.ActiveMQ.md)
...
- [缓存面试题](docs/02.编程/03.Java/14.中间件/02.缓存/01.缓存面试题.md)
- [Java 缓存中间件](docs/02.编程/03.Java/14.中间件/02.缓存/02.Java缓存中间件.md)
- [Memcached 快速入门](docs/02.编程/03.Java/14.中间件/02.缓存/03.Memcached.md)
- [Ehcache 快速入门](docs/02.编程/03.Java/14.中间件/02.缓存/04.Ehcache.md)
- [Java 进程内缓存](docs/02.编程/03.Java/14.中间件/02.缓存/05.Java进程内缓存.md)
- [Http 缓存](docs/02.编程/03.Java/14.中间件/02.缓存/06.Http缓存.md)

##### 流量控制

- [Hystrix](docs/02.编程/03.Java/14.中间件/03.流量控制/01.Hystrix.md)

## 设计

### 架构

- [系统架构面试总结](docs/03.设计/01.架构/01.系统架构面试.md)
- [系统架构概述](docs/03.设计/01.架构/02.系统架构概述.md)
- [系统高性能架构](docs/03.设计/01.架构/03.系统高性能架构.md)
- [系统高可用架构](docs/03.设计/01.架构/04.系统高可用架构.md)
- [系统伸缩性架构](docs/03.设计/01.架构/05.系统伸缩性架构.md)
- [系统扩展性架构](docs/03.设计/01.架构/06.系统扩展性架构.md)
- [系统安全性架构](docs/03.设计/01.架构/07.系统安全性架构.md)
- [大型系统核心技术](docs/03.设计/01.架构/08.大型系统核心技术.md)
- [领域驱动设计](docs/03.设计/01.架构/09.领域驱动设计.md)
