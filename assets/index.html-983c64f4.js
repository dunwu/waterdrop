import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as l,c,a as n,b as s,d as e,f as i,e as p}from"./app-0dbc8ea8.js";const d={},r=n("h1",{id:"mysql-crud",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mysql-crud","aria-hidden":"true"},"#"),s(" MySQL CRUD")],-1),k={class:"hint-container info"},u=p('<p class="hint-container-title">概述</p><p><strong>CRUD</strong> 由英文单词 <strong>C</strong>reate, <strong>R</strong>ead, <strong>U</strong>pdate, <strong>D</strong>elete 的首字母组成，即<strong>增删改查</strong>。</p><p>本文通过介绍基本的 MySQL CRUD 方法，向读者呈现如何访问 MySQL 数据。</p>',3),v={href:"https://dunwu.github.io/waterdrop/pages/2a3b4ae0/",target:"_blank",rel:"noopener noreferrer"},m=p(`<h2 id="mysql-连接" tabindex="-1"><a class="header-anchor" href="#mysql-连接" aria-hidden="true">#</a> MySQL 连接</h2><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code>mysql <span class="token operator">-</span>u <span class="token operator">&lt;</span><span class="token keyword">user</span><span class="token operator">&gt;</span> <span class="token operator">-</span>p
