...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>Map</code> 接口的 <code>merge()</code> 方法如下，这个方法是接口中的默认实现。</p>`,16),u={href:"https://mp.weixin.qq.com/s/ojyl7B6PiHaTWADqmUq2rw",target:"_blank",rel:"noopener noreferrer"},p=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>default V merge(K key, V value,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4、使用 Guava</p>`,30),y={href:"https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/ImmutableList.java",target:"_blank",rel:"noopener noreferrer"},f=n("code",null,"ImmutableList",-1),q={href:"https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/ImmutableList.java#L101",target:"_blank",rel:"noopener noreferrer"},_=n("code",null,"of()",-1),A={href:"https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/ImmutableList.java#L225",target:"_blank",rel:"noopener noreferrer"},w=n("code",null,"copyOf()",-1),O=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>List&lt;String&gt; il = ImmutableList.of(&quot;string&quot;, &quot;elements&quot;);  // from varargs
List&lt;String&gt; il = ImmutableList.copyOf(aStringArray);      // from array
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,1),j={href:"https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/Lists.java",target:"_blank",rel:"noopener noreferrer"},C=n("code",null,"Lists",-1),I={href:"https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/Lists.java#L87",target:"_blank",rel:"noopener noreferrer"},S=n("code",null,"newArrayList()",-1),E=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>List&lt;String&gt; l1 = Lists.newArrayList(anotherListOrCollection);    // from collection
...
<span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">oom</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>出现 OOM 的原因是，循环中的 1000 个具有 10 万个元素的 List 始终得不到回收，因为它始终被 subList 方法返回的 List 强引用。</p><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>`,11),T={href:"https://time.geekbang.org/column/intro/100047701",target:"_blank",rel:"noopener noreferrer"};function M(V,U){const s=l("ExternalLinkIcon");return o(),c("div",null,[r,n("blockquote",null,[n("p",null,[e("如果你还不了解 Java 8 新特性的话，请看这篇文章："),n("a",u,[e("《Java8 新特性总结》"),a(s)]),e(" 。")])]),p,n("blockquote",null,[v,n("p",null,[e("相关阅读："),n("a",m,[e("什么是 fail-fast"),a(s)]),e(" 。")])]),b,n("p",null,[e("由于 JVM 优化，"),g,e("作为"),k,e("方法的参数现在使用更好，"),h,e("就是起一个模板的作用，指定了返回数组的类型，0 是为了节省空间，因为它只是为了说明返回的类型。详见："),n("a",x,[e("https://shipilev.net/blog/2016/arrays-wisdom-ancients/"),a(s)])]),L,n("p",null,[e("对于不可变集合，你可以使用 "),n("a",y,[f,a(s)]),e(" 类及其 "),n("a",q,[_,a(s)]),e(" 与 "),n("a",A,[w,a(s)]),e(" 工厂方法：（参数不能为空）")]),O,n("p",null,[e("对于可变集合，你可以使用 "),n("a",j,[C,a(s)]),e(" 类及其 "),n("a",I,[S,a(s)]),e(" 工厂方法：")]),E,n("ul",null,[n("li",null,[n("a",T,[e("极客时间教程 - Java 业务开发常见错误 100 例"),a(s)])])])])}const z=t(d,[["render",M],["__file","index.html.vue"]]);export{z as default};
