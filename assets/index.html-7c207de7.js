...
DELETE my-index-000001
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="type-query" tabindex="-1"><a class="header-anchor" href="#type-query" aria-hidden="true">#</a> type query</h3><blockquote><p>7.0.0 后废弃</p></blockquote>`,6),Ws={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-type-query.html",target:"_blank",rel:"noopener noreferrer"},Qs=n("strong",null,[n("code",null,"type query")],-1),Rs=t(`<p>示例：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>GET /_search
<span class="token punctuation">{</span>
  <span class="token string">&quot;query&quot;</span><span class="token builtin class-name">:</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="复合查询" tabindex="-1"><a class="header-anchor" href="#复合查询" aria-hidden="true">#</a> 复合查询</h2><p>复合查询就是把一些简单查询组合在一起实现更复杂的查询需求，除此之外，复合查询还可以控制另外一个查询的行为。</p><p>复合查询有以下类型：</p>`,5),ee={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-bool-query.html",target:"_blank",rel:"noopener noreferrer"},ae=n("code",null,"bool",-1),te={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-boosting-query.html",target:"_blank",rel:"noopener noreferrer"},ie=n("code",null,"boosting",-1),le={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-constant-score-query.html",target:"_blank",rel:"noopener noreferrer"},oe=n("code",null,"constant_score",-1),ue={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-dis-max-query.html",target:"_blank",rel:"noopener noreferrer"},ce=n("code",null,"dis_max",-1),re={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl-function-score-query.html",target:"_blank",rel:"noopener noreferrer"},de=n("code",null,"function_score",-1),pe=t(`<h3 id="bool-query" tabindex="-1"><a class="header-anchor" href="#bool-query" aria-hidden="true">#</a> bool query</h3><p>bool 查询可以把任意多个简单查询组合在一起，使用 must、should、must_not、filter 选项来表示简单查询之间的逻辑，每个选项都可以出现 0 次到多次，它们的含义如下：</p><ul><li>must 文档必须匹配 must 选项下的查询条件，相当于逻辑运算的 AND，且参与文档相关度的评分。</li><li>should 文档可以匹配 should 选项下的查询条件也可以不匹配，相当于逻辑运算的 OR，且参与文档相关度的评分。</li><li>must_not 与 must 相反，匹配该选项下的查询条件的文档不会被返回；需要注意的是，<strong>must_not 语句不会影响评分，它的作用只是将不相关的文档排除</strong>。</li><li>filter 和 must 一样，匹配 filter 选项下的查询条件的文档才会被返回，<strong>但是 filter 不评分，只起到过滤功能，与 must_not 相反</strong>。</li></ul><p>假设要查询 title 中包含关键词 java，并且 price 不能高于 70，description 可以包含也可以不包含虚拟机的书籍，构造 bool 查询语句如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>GET books/_search
{
  &quot;query&quot;: {
    &quot;bool&quot;: {
      &quot;filter&quot;: {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>文档符合 query 中的条件，返回结果中可以查到上文中注册的 bool query。percolate query 的这种特性适用于数据分类、数据路由、事件监控和预警等场景。</p><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>`,70),he={href:"https://time.geekbang.org/course/detail/100030501-102659",target:"_blank",rel:"noopener noreferrer"};function ke(ge,_e){const e=l("ExternalLinkIcon");return o(),u("div",null,[r,d,p,n("ul",null,[n("li",null,[s("叶子查询 - 在指定字段中查找特定值，例如："),n("a",v,[m,a(e)]),s("、"),n("a",q,[b,a(e)]),s(" 和 "),n("a",h,[k,a(e)]),s("。")]),n("li",null,[s("组合查询 - 组合其他叶子查询或组合查询，用于以逻辑方式组合多个查询（例如： "),n("a",g,[_,a(e)]),s("、"),n("a",y,[f,a(e)]),s("），或更改它们的行为（例如："),n("a",x,[w,a(e)]),s("）。")])]),T,n("ul",null,[n("li",null,[n("a",E,[s("Compound（组合查询）"),a(e)])]),n("li",null,[n("a",G,[s("Term-level（词项查询）"),a(e)])]),n("li",null,[n("a",z,[s("Full text（全文查询）"),a(e)])]),n("li",null,[n("a",S,[s("Joining（联结查询）"),a(e)])]),n("li",null,[n("a",P,[s("Specialized（专用查询）"),a(e)])]),n("li",null,[n("a",D,[s("Geo（地理位置查询）"),a(e)])]),n("li",null,[n("a",L,[s("Span（跨度查询）"),a(e)])]),n("li",null,[n("a",O,[s("Vector（向量查询）"),a(e)])]),n("li",null,[n("a",A,[s("Shape（形状查询）"),a(e)])])]),U,N,H,n("ul",null,[n("li",null,[n("a",B,[s("intervals"),a(e)])]),n("li",null,[n("a",I,[s("match"),a(e)])]),n("li",null,[n("a",j,[s("match_bool_prefix"),a(e)])]),n("li",null,[n("a",J,[s("match_phrase"),a(e)])]),n("li",null,[n("a",K,[s("match_phrase_prefix"),a(e)])]),n("li",null,[n("a",F,[s("combined_fields"),a(e)])]),n("li",null,[n("a",C,[s("multi_match"),a(e)])]),n("li",null,[n("a",W,[s("query_string"),a(e)])]),n("li",null,[n("a",Q,[s("simple_query_string"),a(e)])])]),R,n("p",null,[n("a",V,[X,a(e)]),s(" 根据匹配词的顺序和近似度返回文档。")]),M,n("p",null,[n("a",$,[Y,a(e)]),s(),Z,s("，首先会针对查询语句进行解析（经过 analyzer），主要是对查询语句进行分词，分词后查询语句的任何一个词项被匹配，文档就会被搜到，默认情况下相当于对分词后词项进行 or 匹配操作。")]),n("p",null,[n("a",nn,[sn,a(e)]),s(" 是执行全文搜索的标准查询，包括模糊匹配选项。")]),en,n("p",null,[s("匹配查询是布尔类型。这意味着会对提供的文本进行分析，分析过程从提供的文本构造一个布尔查询。 "),an,s(" 参数可以设置为 "),tn,s(" 或 "),ln,s(" 来控制布尔子句（默认为 "),on,s("）。可以使用 "),n("a",un,[cn,a(e)]),s(" 参数设置要匹配的可选 "),rn,s(" 子句的最小数量。")]),dn,n("p",null,[pn,s(" 允许基于被查询字段的类型进行模糊匹配。请参阅 "),n("a",vn,[s("Fuzziness"),a(e)]),s(" 的配置。")]),mn,n("p",null,[n("a",qn,[bn,a(e)]),s(" 分析其输入并根据这些词构造一个布尔查询。除了最后一个术语之外的每个术语都用于术语查询。最后一个词用于 "),hn,s("。")]),kn,n("p",null,[n("a",gn,[_n,a(e)]),s(" 即短语匹配，首先会把 query 内容分词，分词器可以自定义，同时文档还要满足以下两个条件才会被搜索到：")]),yn,n("p",null,[n("a",fn,[xn,a(e)]),s(" 和 "),n("a",wn,[Tn,a(e)]),s(" 类似，只不过 "),n("a",En,[Gn,a(e)]),s(" 最后一个 term 会被作为前缀匹配。")]),zn,n("p",null,[n("a",Sn,[Pn,a(e)]),s(" 是 "),Dn,s(" 的升级，"),Ln,s("。")]),On,n("p",null,[n("a",An,[Un,a(e)]),s(" 支持搜索多个文本字段，就好像它们的内容已被索引到一个组合字段中一样。该查询会生成以 term 为中心的输入字符串视图：首先它将查询字符串解析为独立的 term，然后在所有字段中查找每个 term。当匹配结果可能跨越多个文本字段时，此查询特别有用，例如文章的标题、摘要和正文：")]),Nn,n("p",null,[n("a",Hn,[Bn,a(e)]),s(" 是一种在不牺牲性能的情况下替代停用词提高搜索准确率和召回率的方案。")]),In,n("p",null,[n("a",jn,[Jn,a(e)]),s(" 是与 Lucene 查询语句的语法结合非常紧密的一种查询，允许在一个查询语句中使用多个特殊条件关键字（如：AND | OR | NOT）对多个字段进行查询，建议熟悉 Lucene 查询语法的用户去使用。")]),Kn,n("p",null,[n("a",Fn,[Cn,a(e)]),s(" 是一种适合直接暴露给用户，并且具有非常完善的查询语法的查询语句，接受 Lucene 查询语法，解析过程中发生错误不会抛出异常。")]),n("p",null,[s("虽然语法比 "),n("a",Wn,[Qn,a(e)]),s(" 更严格，但 "),n("a",Rn,[Vn,a(e)]),s(" 不会返回无效语法的错误。相反，它会忽略查询字符串的任何无效部分。")]),Xn,n("ul",null,[n("li",null,[n("strong",null,[n("a",Mn,[s("exists"),a(e)])])]),n("li",null,[n("strong",null,[n("a",$n,[s("fuzzy"),a(e)])])]),n("li",null,[n("strong",null,[n("a",Yn,[s("ids"),a(e)])])]),n("li",null,[n("strong",null,[n("a",Zn,[s("prefix"),a(e)])])]),n("li",null,[n("strong",null,[n("a",ns,[s("range"),a(e)])])]),n("li",null,[n("strong",null,[n("a",ss,[s("regexp"),a(e)])])]),n("li",null,[n("strong",null,[n("a",es,[s("term"),a(e)])])]),n("li",null,[n("strong",null,[n("a",as,[s("terms"),a(e)])])]),n("li",null,[n("strong",null,[n("a",ts,[s("terms set"),a(e)])])]),n("li",null,[n("strong",null,[n("a",is,[s("wildcard"),a(e)])])])]),ls,n("p",null,[n("a",os,[us,a(e)]),s(" 会返回字段中至少有一个非空值的文档。")]),cs,n("p",null,[n("a",rs,[ds,s("（模糊查询）"),a(e)]),s(" 返回包含与搜索词相似的词的文档。ES 使用 "),n("a",ps,[s("Levenshtein edit distance（Levenshtein 编辑距离）"),a(e)]),s(" 测量相似度或模糊度。")]),vs,n("p",null,[s("注意：如果配置了 "),n("a",ms,[qs,a(e)]),s(" ，则 fuzzy query 不能执行。")]),bs,n("p",null,[n("a",hs,[ks,a(e)]),s(" 根据 ID 返回文档。 此查询使用存储在 "),gs,s(" 字段中的文档 ID。")]),_s,n("p",null,[n("a",ys,[fs,a(e)]),s(" 用于查询某个字段中包含指定前缀的文档。")]),xs,n("p",null,[n("a",ws,[Ts,a(e)]),s(" 即范围查询，用于匹配在某一范围内的数值型、日期类型或者字符串型字段的文档。比如搜索哪些书籍的价格在 50 到 100 之间、哪些书籍的出版时间在 2015 年到 2019 年之间。"),Es,s("。")]),Gs,n("p",null,[n("a",zs,[Ss,a(e)]),s(" 返回与正则表达式相匹配的 term 所属的文档。")]),n("p",null,[n("a",Ps,[s("正则表达式"),a(e)]),s(" 是一种使用占位符字符匹配数据模式的方法，称为运算符。")]),Ds,n("blockquote",null,[n("p",null,[s("注意：如果配置了 "),n("a",Ls,[Os,a(e)]),s(" ，则 "),n("a",As,[Us,a(e)]),s(" 会被禁用。")])]),Ns,n("p",null,[n("a",Hs,[Bs,a(e)]),s(" 用来查找指定字段中包含给定单词的文档，term 查询不被解析，只有查询词和文档中的词精确匹配才会被搜索到，应用场景为查询人名、地名等需要精准匹配的需求。")]),Is,n("p",null,[n("a",js,[Js,a(e)]),s(" 与 "),n("a",Ks,[Fs,a(e)]),s(" 相同，但可以搜索多个值。")]),Cs,n("p",null,[n("a",Ws,[Qs,a(e)]),s(" 用于查询具有指定类型的文档。")]),Rs,n("p",null,[n("a",Vs,[Xs,a(e)]),s(" 即通配符查询，返回与通配符模式匹配的文档。")]),Ms,n("blockquote",null,[n("p",null,[s("注意：如果配置了 "),n("a",$s,[Ys,a(e)]),s(" ，则 "),n("a",Zs,[ne,a(e)]),s(" 会被禁用。")])]),se,n("ul",null,[n("li",null,[n("a",ee,[ae,a(e)]),s(" - 布尔查询，可以组合多个过滤语句来过滤文档。")]),n("li",null,[n("a",te,[ie,a(e)]),s(" - 在 positive 块中指定匹配文档的语句，同时降低在 negative 块中也匹配的文档的得分，提供调整相关性算分的能力。")]),n("li",null,[n("a",le,[oe,a(e)]),s(" - 包装了一个过滤器查询，不进行算分。")]),n("li",null,[n("a",ue,[ce,a(e)]),s(" - 返回匹配了一个或者多个查询语句的文档，但只将最佳匹配的评分作为相关性算分返回。")]),n("li",null,[n("a",re,[de,a(e)]),s(" - 支持使用函数来修改查询返回的分数。")])]),pe,n("p",null,[s("有关布尔查询更详细的信息参考 "),n("a",ve,[s("bool query（组合查询）详解"),a(e)]),s("。")]),me,n("p",null,[s("关于 function_score 的更多详细内容请查看 "),n("a",qe,[s("Elasticsearch function_score 查询最强详解"),a(e)]),s("。")]),be,n("ul",null,[n("li",null,[n("a",he,[s("极客时间教程 - Elasticsearch 核心技术与实战"),a(e)])])])])}const xe=i(c,[["render",ke],["__file","index.html.vue"]]);export{xe as default};
