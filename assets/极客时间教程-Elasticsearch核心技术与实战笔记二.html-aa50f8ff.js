import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as i,c as e,a as n,b as l,d as p,e as u}from"./app-9fd7837b.js";const o={},c=u(`<h1 id="《极客时间教程-elasticsearch-核心技术与实战》笔记二" tabindex="-1"><a class="header-anchor" href="#《极客时间教程-elasticsearch-核心技术与实战》笔记二" aria-hidden="true">#</a> 《极客时间教程 - Elasticsearch 核心技术与实战》笔记二</h1><h2 id="深入-es-查询" tabindex="-1"><a class="header-anchor" href="#深入-es-查询" aria-hidden="true">#</a> 深入 ES 查询</h2><h3 id="基于词项和基于全文的搜索" tabindex="-1"><a class="header-anchor" href="#基于词项和基于全文的搜索" aria-hidden="true">#</a> 基于词项和基于全文的搜索</h3><h4 id="基于词项的查询" tabindex="-1"><a class="header-anchor" href="#基于词项的查询" aria-hidden="true">#</a> 基于词项的查询</h4><p>Term 是表达语意的最小单位。搜索和利用统计语言模型进行自然语言处理都需要处理 Term</p><p>Term 级别查询：Term / Range / Exists / Prefix / Wildcard</p><p>在 ES 中，Term 查询，对输入不做分词。会将输入作为一个整体，在倒排索引中查找准确的词项，并且使用相关度计算公式为每个包含该词项的文档进行相关度计算。</p><p>可以通过 Constant Score 将查询转换成一个 Filtering，避免算法，并利用缓存，提高性能。</p><h4 id="基于文本的查询" tabindex="-1"><a class="header-anchor" href="#基于文本的查询" aria-hidden="true">#</a> 基于文本的查询</h4><p>文本查询：match、match_phrase、query_string</p><p>索引和搜索时都会进行分词，查询字符串先传递到一个合适的分词器，然后生成一个供查询的词项列表。</p><p>查询时，会先对输入的查询进行分词，然后每个词项柱哥进行底层的查询，最终将结果进行合并，并为每个文档计算一个相关度分值。</p><p>【示例】</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>DELETE products
PUT products
