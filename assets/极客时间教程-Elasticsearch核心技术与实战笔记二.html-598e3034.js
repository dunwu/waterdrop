...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="处理并发读写" tabindex="-1"><a class="header-anchor" href="#处理并发读写" aria-hidden="true">#</a> 处理并发读写</h3><p>采用乐观锁机制</p><p>内部版本控制：<code>_seq_no</code> + <code>primary_term</code></p><p>外部版本控制：<code>version</code> + <code>version_type=external</code></p><h2 id="第六章-深入聚合分析" tabindex="-1"><a class="header-anchor" href="#第六章-深入聚合分析" aria-hidden="true">#</a> 第六章：深入聚合分析</h2><h3 id="bucket-metric聚合分析及嵌套聚合" tabindex="-1"><a class="header-anchor" href="#bucket-metric聚合分析及嵌套聚合" aria-hidden="true">#</a> Bucket&amp;Metric聚合分析及嵌套聚合</h3><p>Metric（统计） - 统计计算</p><p>Bucket（分组） - 按一定规则，将文档分配到不同的桶中。</p><p>Metric 聚合</p><ul><li><strong>单值聚合</strong> - 只输出一个分析结果 <ul><li>min、max、avg、sum、cardinality</li></ul></li><li><strong>多值聚合</strong> - 输出多个分析结果 <ul><li>stats、extended_stats、percentile、percentile_rank、top_hits</li></ul></li></ul><h3 id="pipeline聚合分析" tabindex="-1"><a class="header-anchor" href="#pipeline聚合分析" aria-hidden="true">#</a> Pipeline聚合分析</h3><p>Pipeline聚合支持对聚合分析的结果，进行再次聚合分析。</p><p>Pipeline 聚合的分析结果会输出到原结果中，根据位置的不同，分为两类：</p>`,182),r=s("strong",null,"sibling",-1),d={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-max-bucket-aggregation.html",target:"_blank",rel:"noopener noreferrer"},k={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-min-bucket-aggregation.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-avg-bucket-aggregation.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-sum-bucket-aggregation.html",target:"_blank",rel:"noopener noreferrer"},b={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-stats-bucket-aggregation.html",target:"_blank",rel:"noopener noreferrer"},q={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-extended-stats-bucket-aggregation.html",target:"_blank",rel:"noopener noreferrer"},g={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-percentiles-bucket-aggregation.html",target:"_blank",rel:"noopener noreferrer"},h=s("strong",null,"parent",-1),_={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-derivative-aggregation.html",target:"_blank",rel:"noopener noreferrer"},f={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-cumulative-sum-aggregation.html",target:"_blank",rel:"noopener noreferrer"},y={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-pipeline-movfn-aggregation.html",target:"_blank",rel:"noopener noreferrer"},x=e('<h3 id="聚合的作用范围及排序" tabindex="-1"><a class="header-anchor" href="#聚合的作用范围及排序" aria-hidden="true">#</a> 聚合的作用范围及排序</h3><p>ES 聚合分析的默认作用范围是 query 的查询结果集。</p><p>同时 ES 还支持以下方式改变聚合的作用范围：</p><ul><li>filter</li><li>post_filter</li><li>global</li></ul><p>指定 order，按照 <code>_count</code> 和 <code>_key</code> 进行排序。</p><h3 id="聚合分析的原理及精准度问题" tabindex="-1"><a class="header-anchor" href="#聚合分析的原理及精准度问题" aria-hidden="true">#</a> 聚合分析的原理及精准度问题</h3><p>ES 在进行聚合分析时，协调节点会在每个分片的主分片、副分片中选一个，然后在不同分片上分别进行聚合计算，然后将每个分片的聚合结果进行汇总，返回最终结果。</p><p>由于，并非基于全量数据进行计算，所以聚合结果并非完全准确。</p><p>要解决聚合准确性问题，有两个解决方案：</p>',9),T=s("li",null,"解决方案 1：当数据量不大时，设置 Primary Shard 为 1，这意味着在数据全集上进行聚合。",-1),P={href:"https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-bucket-terms-aggregation.html#search-aggregations-bucket-terms-aggregation-shard-size",target:"_blank",rel:"noopener noreferrer"},S=s("code",null,"shard_size",-1),O=s("strong",null,"整体性能变低，精准度变高",-1),E=s("code",null,"size * 1.5 + 10",-1),w=e('<h2 id="第七章-数据建模-略" tabindex="-1"><a class="header-anchor" href="#第七章-数据建模-略" aria-hidden="true">#</a> 第七章：数据建模（略）</h2><h2 id="第八章-保护你的数据-略" tabindex="-1"><a class="header-anchor" href="#第八章-保护你的数据-略" aria-hidden="true">#</a> 第八章：保护你的数据（略）</h2><h2 id="第九章-水平扩展-elasticsearch-集群" tabindex="-1"><a class="header-anchor" href="#第九章-水平扩展-elasticsearch-集群" aria-hidden="true">#</a> 第九章：水平扩展 Elasticsearch 集群</h2><h2 id="第十章-生产环境中的集群运维-略" tabindex="-1"><a class="header-anchor" href="#第十章-生产环境中的集群运维-略" aria-hidden="true">#</a> 第十章：生产环境中的集群运维（略）</h2><h2 id="第十一章-索引生命周期管理-略" tabindex="-1"><a class="header-anchor" href="#第十一章-索引生命周期管理-略" aria-hidden="true">#</a> 第十一章：索引生命周期管理（略）</h2><h2 id="第十二章-用logstash和beats构建数据管道-略" tabindex="-1"><a class="header-anchor" href="#第十二章-用logstash和beats构建数据管道-略" aria-hidden="true">#</a> 第十二章：用Logstash和Beats构建数据管道（略）</h2><h2 id="第十三章-用kibana进行数据可视化分析-略" tabindex="-1"><a class="header-anchor" href="#第十三章-用kibana进行数据可视化分析-略" aria-hidden="true">#</a> 第十三章：用Kibana进行数据可视化分析（略）</h2><h2 id="第十四章-探索x-pack套件-略" tabindex="-1"><a class="header-anchor" href="#第十四章-探索x-pack套件-略" aria-hidden="true">#</a> 第十四章：探索X-Pack套件（略）</h2><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>',9),D={href:"https://time.geekbang.org/course/detail/100030501-102659",target:"_blank",rel:"noopener noreferrer"};function I(A,L){const a=l("ExternalLinkIcon");return p(),u("div",null,[o,s("ul",null,[s("li",null,[r,n(" - 结果和现有分析结果同级。例如："),s("a",d,[n("max_bucket"),t(a)]),n("、"),s("a",k,[n("min_bucket"),t(a)]),n("、"),s("a",v,[n("avg_bucket"),t(a)]),n("、"),s("a",m,[n("sum_bucket"),t(a)]),n("、"),s("a",b,[n("stats_bucket"),t(a)]),n("、"),s("a",q,[n("extended_stats_bucket"),t(a)]),n("、"),s("a",g,[n("percentiles_bucket"),t(a)]),n("。")]),s("li",null,[h,n(" - 结果内嵌到现有的聚合分析结果中。例如："),s("a",_,[n("derivative"),t(a)]),n("、"),s("a",f,[n("cumulative_sum"),t(a)]),n("、"),s("a",y,[n("moving_function"),t(a)]),n("。")])]),x,s("ul",null,[T,s("li",null,[n("解决方案 2：设置 "),s("a",P,[S,t(a)]),n(" 参数，将计算数据范围变大，进而使得 ES 的"),O,n("。shard_size 值的默认值是 "),E,n("。")])]),w,s("ul",null,[s("li",null,[s("a",D,[n("极客时间教程 - Elasticsearch 核心技术与实战"),t(a)])])])])}const X=i(c,[["render",I],["__file","极客时间教程-Elasticsearch核心技术与实战笔记二.html.vue"]]);export{X as default};
