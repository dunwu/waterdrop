...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-deployment-diagram-example.png)

### 节点

节点既可以是硬件元素，也可以是软件元素。它显示为一个立方体，如下图所示。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-node.gif)

### 节点实例

图可以显示节点实例，实例与节点的区分是：实例的名称带下划线，冒号放在它的基本节点类型之前。实例在冒号之前可以有名称，也可以没有名称。下图显示了一个具名的计算机实例。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-node-instance.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-node-stereotype.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-artifact.gif)

### 关联

在部署图的上下文联系中，关联代表节点间的联系通道。下图显示了一个网络系统的部署图，描述了网络协议为构造型和关联终端的多重性，

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-network-model.gif)

### 作为容器的节点

节点可以包含其他元素，如组件和工件。下图显示了一个嵌入式系统某个部分的部署图。描写了一个被主板节点包含的可执行工件。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-embedded-model.gif)

## 组件图

> **组件图（Component Diagram）描绘了组成一个软件系统的模块和嵌入控件**。组件图比类图具有更高层次的抽象－通常运行时一个组件被一个或多个类（或对象）实现。它们象积木那样使得组件能最终构成系统的绝大部分。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-component-diagram.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-representing-components.gif)

### 装配连接器

装配连接器在组件 “Component1”的需求接口和另一个组件 “Component2”的提供接口之间建立桥梁; 这个桥梁使得一个组件能提供另一个组件所需要的服务。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-required-interfaces.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-component-with-ports.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-package-diagram.gif)

包中的元素共享相同的命名空间，因此，一个指定命名空间的元素必须有唯一的名称。

包可以用来代表物理或逻辑关系。选择把类包括在指定的包里，有助于在同一个包里赋予这些类相同继承层次。通常认为把通过复合相关联的类，以及与它们相协作的类放在同一个包里。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-package.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-class-diagram.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-class.gif)

### 接口（Interfaces）

接口是实施者同意满足的行为规范，是一种约定。实现一个接口，类必需支持其要求的行为，使系统按照同样的方式，即公共的接口，处理不相关的元素。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-class-interface.gif)

接口有相似于类的外形风格，含有指定的操作，如下图所示。如果没有明确的详细操作，也可以画成一个圆环。当画成圆环的时候，到这个环形标柱的实现连接没有目标箭头。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-interface.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-table.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-associations.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-generalizations.gif)

下图显示了与上图相同信息的视图。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-generalizations-02.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-aggregations.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-association-classes.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-realizations.gif)

### 嵌套（Nestings）

嵌套连接符用来表示源元素嵌套在目标元素中。下图显示“ inner class”的定义，尽管在 EA 中，更多地按照着他们在项目层次视图中的位置来显示这种关系。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-nestings.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-composite-structure-diagram.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-part.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-port.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-interface-02.gif)

### 委托

委托连接器用来定义组件外部端口和接口的内部工作方式。委托连接器表示为带有 «delegate» 关键字的箭头。它连接组件的外部约定，表现为它的端口，到组件部件行为的内部实现。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-delegate.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-collaboration.gif)

### 角色绑定

角色绑定连接器是一条从连接协作到所要完成该任务类元的连线。它显示为虚线，并在类元端显示作用名。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-role-binding.gif)

### 表现

表现连接器用于连接协作到类元来表示此类元中使用了该协作。显示为带关键字 «represents»的虚线箭头。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-represent.gif)

发生
发生连接器用于连接协作到类元来表示此协作表现了（同原文）该类元；显示为带关键字«occurrence»的虚线箭头。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-occurrence.gif)
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-object.gif)

### 运行状态

类元元素可以有任意数量的属性和操作。在对象实例中不会被显示出来。但可能定义对象的运行状态，显示特殊实例的属性设置值。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-run-time-state.gif)

### 类和对象图示例

下图是一个对象图，其中插入了类定义图。它例示如何用对象图来测试类图中任务多重性的方法。“car” 类对 “wheel” 类有“1 对多” 的多重性，但是如果已经选择用“1 对 4” 来替代，那样就不会在对象图显示“3 个轮子”的汽车。

![](https://raw.githubusercontent.com/dunwu/images/master/cs/design/uml/uml-object-diagram.gif)
