...
- [如何设计系统](综合/如何设计系统.md) - 关键词：`系统设计`、`需求分析`、`顶层设计`、`瓶颈分析`、`水平扩展`
- [系统架构面试总结](综合/系统架构面试.md) - 💯
- [系统架构概述](综合/系统架构概述.md) - 关键词：`架构演化`、`分层架构`、`微服务`、`事件驱动`、`微核架构`
- [系统高性能架构](综合/系统高性能架构.md) - 关键词：`高性能`、`缓存`、`并发模型`、`Reactor`、`负载均衡`
- [系统高可用架构](综合/系统高可用架构.md) - 关键词：`高可用`、`CAP`、`主从复制`、`限流降级熔断`、`失效转移`
- [系统伸缩性架构](综合/系统伸缩性架构.md) - 关键词：`伸缩性`、`负载均衡`、`集群`、`一致性 Hash`、`分库分表`
- [系统扩展性架构](综合/系统扩展性架构.md) - 关键词：`扩展性`、`分层架构`、`SOA`、`微服务`、`消息队列`
- [系统安全性架构](综合/系统安全性架构.md) - 关键词：`SSO`、`OAuth2`、`RBAC`、`XSS`、`CSRF`
- [大型系统核心技术](综合/大型系统核心技术.md) - 关键词：`分布式锁`、`分布式 Session`、`分布式缓存`、`负载均衡`、`分布式存储`
- [系统测试架构](综合/系统测试架构.md) - 关键词：`黑盒测试`、`白盒测试`、`单元测试`、`集成测试`、`性能测试`

### 微服务

- [微服务简介](微服务/微服务简介.md) - 关键词：`定义`、`演进`、`利弊`、`如何拆分`、`容量规划`
- [微服务之注册和发现](微服务/微服务之注册和发现.md) - 关键词：`服务定义`、`注册中心`、`元数据`、`健康检查`、`服务订阅`
- [微服务之服务调用](微服务/微服务之服务调用.md) - 关键词：`RPC`、`通信协议`、`传输方式`、`序列化`
- [微服务基本原理](微服务/微服务基本原理.md) - 关键词：`微服务`、`序列化`、`动态代理`、`通信`、`服务注册发现`

### 安全

- [权限认证综述](安全/综述.md) - 关键词：`认证`、`授权`、`身份验证`、`访问控制`、`安全架构`
- [认证设计](安全/认证.md) - 关键词：`认证`、`多因素认证`、`OAuth2`、`JWT`、`单点登录`
- [授权设计](安全/授权.md) - 关键词：`授权`、`RBAC`、`ABAC`、`ACL`、`权限控制`
- [安全漏洞](安全/安全漏洞.md) - 关键词：`XSS`、`CSRF`、`SQL 注入`、`安全漏洞`、`漏洞防护`
- [编码和加密](安全/编码和加密.md) - 关键词：`对称加密`、`非对称加密`、`消息摘要`、`数字签名`、`Base64`
