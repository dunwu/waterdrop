...
![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320115836.png)

在上面的例子中，数组 a 中有 5 个元素。`也就是说`，a 的长度是 6 。我们可以使用 a[0] 来表示数组中的第一个元素。因此，a[0] = A 。类似地，a[1] = B，a[2] = C，依此类推。

### 数组的插入

![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320115848.png)

### 数组的删除

![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320115859.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320152607.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320174829.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320174908.png)

（2）将 `cur` 的 `next` 字段链接到 `prev` 的下一个结点 `next` ；

![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320174919.png)

（3）将 `prev` 中的 `next` 字段链接到 `cur` 。

![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320174932.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320174953.png)

（2）接下来链接 `prev` 到 `cur` 的下一个节点 `next` 。

![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320175006.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320181150.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320181208.png)

（2）链接 `cur` 与 `prev` 和 `next`，其中 `next` 是 `prev` 原始的下一个节点；

![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320181303.png)

（3）用 `cur` 重新链接 `prev` 和 `next`。

![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220320181504.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220322190534.png)

#### 循环双链表

![](https://raw.githubusercontent.com/dunwu/images/master/snap/20220322190423.png)
