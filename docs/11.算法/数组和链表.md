...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/ca43df07583a48ad92cd9c64e7544577.png)

在上面的例子中，数组 a 中有 5 个元素。`也就是说`，a 的长度是 6 。我们可以使用 a[0] 来表示数组中的第一个元素。因此，a[0] = A 。类似地，a[1] = B，a[2] = C，依此类推。

### 数组的插入

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/514331bed66a4b6db6ee74d6d1095c38.png)

### 数组的删除

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/49d500c8d26e4e92abcc2b348f43c3a5.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/ccf803c5d8604e37ba104237105f540c.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/99337746b5604c08b62d070120d6b8d2.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/aefb8504ae834a1197de4ffd31852615.png)

（2）将 `cur` 的 `next` 字段链接到 `prev` 的下一个结点 `next` ；

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/603a46627a3543deb98e1e4e2a651cfc.png)

（3）将 `prev` 中的 `next` 字段链接到 `cur` 。

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/ccb7dc3e2fbb4710a95149c595950570.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/603607a079a742b59b84fc31da4e9dfa.png)

（2）接下来链接 `prev` 到 `cur` 的下一个节点 `next` 。

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/8eed4f6539db4438ba6a8932b39ebb28.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/9a94a456e2ef4b9788385f70e7bea36f.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/f63f1a72e7ea4642841a64c52c076681.png)

（2）链接 `cur` 与 `prev` 和 `next`，其中 `next` 是 `prev` 原始的下一个节点；

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/588e8df4e7ed42aeadeb0ad5424ef27d.png)

（3）用 `cur` 重新链接 `prev` 和 `next`。

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/588fb63422eb4dd9b2efe3622acf72d2.png)
...
![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/43d4e0f27b184ed180c90e590fb188b6.png)

#### 循环双链表

![](https://raw.githubusercontent.com/dunwu/images/master/archive/2022/03/79bd695137e34237ba627470745bfda9.png)
