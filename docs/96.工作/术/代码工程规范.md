...
tags:
  - 效率提升
  - 规范
permalink: /pages/d3f9b54a/
---

# 代码工程规范

> 统一的项目规范是团队协作的基础。良好的规范能够降低沟通成本、减少潜在错误、提升代码的可维护性和可读性。
>
> 本文从项目结构、命名规则、Java 日志规范三个维度，梳理软件开发中的核心工程规范。

## 1. 项目结构

以下为项目根目录下的文件和目录的推荐组织结构：
...
> 以下规范基于[阿里巴巴 Java 开发手册](https://yq.aliyun.com/attachment/download/?id=4942)日志规约章节，结合开发实践做了增删和调整。
...
![](https://raw.githubusercontent.com/dunwu/images/master/cs/java/javalib/log/logback/log-pattern.png)
...
9. 【参考】有一些第三方框架或库的日志对于排查问题具有一定的帮助，如 Spring、Dubbo、MyBatis 等。这些框架所使用的日志库未必和本项目一样，为了避免出现日志无法输出的问题，请引入对应的桥接 jar 包。
