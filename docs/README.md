...
- [计算机网络面试总结](01.计算机科学/03.网络/01.计算机网络面试总结.md)
- [计算机网络指南](01.计算机科学/03.网络/02.计算机网络指南.md) - 关键词：核心概念、拓扑结构、作用范围、性能指标、体系结构
...
- [计算机网络之物理层](01.计算机科学/03.网络/01.网络分层/01.物理层.md) - 关键词：调制、解调、数字信号、模拟信号、通信媒介、信道复用
- [计算机网络之数据链路层](01.计算机科学/03.网络/01.网络分层/02.数据链路层.md) - 关键词：点对点信道、广播信道、`PPP`、`CSMA/CD`、局域网、以太网、`MAC`、适配器、集线器、网桥、交换机
- [计算机网络之网络层](01.计算机科学/03.网络/01.网络分层/03.网络层.md) - 关键词：`IP`、`ICMP`、`ARP`、路由
- [计算机网络之传输层](01.计算机科学/03.网络/01.网络分层/04.传输层.md) - 关键词：`UDP`、`TCP`、滑动窗口、拥塞控制、三次握手
- [计算机网络之应用层](01.计算机科学/03.网络/01.网络分层/05.应用层.md) - 关键词：`HTTP`、`DNS`、`FTP`、`TELNET`、`DHCP`
...
- [JavaWeb 面经](02.编程/03.Java/02.JavaEE/01.JavaWeb/99.JavaWeb面经.md)
- [JavaWeb 之 Servlet 指南](02.编程/03.Java/02.JavaEE/01.JavaWeb/01.JavaWeb之Servlet指南.md)
- [JavaWeb 之 Jsp 指南](02.编程/03.Java/02.JavaEE/01.JavaWeb/02.JavaWeb之Jsp指南.md)
- [JavaWeb 之 Filter 和 Listener](02.编程/03.Java/02.JavaEE/01.JavaWeb/03.JavaWeb之Filter和Listener.md)
- [JavaWeb 之 Cookie 和 Session](02.编程/03.Java/02.JavaEE/01.JavaWeb/04.JavaWeb之Cookie和Session.md)
...
- [Tomcat 快速入门](02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/01.Tomcat快速入门.md)
- [Tomcat 连接器](02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/02.Tomcat连接器.md)
- [Tomcat 容器](02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/03.Tomcat容器.md)
- [Tomcat 优化](02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/04.Tomcat优化.md)
- [Tomcat 和 Jetty](02.编程/03.Java/02.JavaEE/02.服务器/01.Tomcat/05.Tomcat和Jetty.md)
- [Jetty](02.编程/03.Java/02.JavaEE/02.服务器/02.Jetty.md)

#### Java 软件

##### Java 构建

> Java 项目需要通过 [**构建工具**](02.编程/03.Java/11.软件/01.构建) 来管理项目依赖，完成编译、打包、发布、生成 JavaDoc 等任务。
>
> - 目前最主流的构建工具是 Maven，它的功能非常强大。
> - Gradle 号称是要替代 Maven 等构件工具，它的版本管理确实简洁，但是需要学习 Groovy，学习成本比 Maven 高。
> - Ant 功能比 Maven 和 Gradle 要弱，现代 Java 项目基本不用了，但也有一些传统的 Java 项目还在使用。

- [Maven](02.编程/03.Java/11.软件/01.构建/01.Maven) 📚
  - [Maven 快速入门](02.编程/03.Java/11.软件/01.构建/01.Maven/01.Maven快速入门.md)
  - [Maven 教程之 pom.xml 详解](02.编程/03.Java/11.软件/01.构建/01.Maven/02.Maven教程之pom.xml详解.md)
  - [Maven 教程之 settings.xml 详解](02.编程/03.Java/11.软件/01.构建/01.Maven/03.Maven教程之settings.xml详解.md)
  - [Maven 实战问题和最佳实践](02.编程/03.Java/11.软件/01.构建/01.Maven/04.Maven实战问题和最佳实践.md)
  - [Maven 教程之发布 jar 到私服或中央仓库](02.编程/03.Java/11.软件/01.构建/01.Maven/05.Maven教程之发布jar到私服或中央仓库.md)
  - [Maven 插件之代码检查](02.编程/03.Java/11.软件/01.构建/01.Maven/06.Maven插件之代码检查.md)
- [Ant 简易教程](02.编程/03.Java/11.软件/01.构建/02.Ant.md)

##### Java IDE

> 自从有了 [**IDE**](02.编程/03.Java/11.软件/02.IDE)，写代码从此就告别了刀耕火种的蛮荒时代。
>
> - [Eclipse](02.编程/03.Java/11.软件/02.IDE/02.Eclipse.md) 是久负盛名的开源 Java IDE，我的学生时代一直使用它写 Java。
> - 曾经抗拒从转 [Intellij Idea](02.编程/03.Java/11.软件/02.IDE/01.Intellij.md) ，但后来发现真香，不得不说，确实是目前最优秀的 Java IDE。
> - 你可以在 [vscode](02.编程/03.Java/11.软件/02.IDE/03.VsCode.md) 中写各种语言，只要安装相应插件即可。如果你的项目中使用了很多种编程语言，又懒得在多个 IDE 之间切换，那么就用 vscode 来一网打尽吧。

- [Intellij Idea](02.编程/03.Java/11.软件/02.IDE/01.Intellij.md)
- [Eclipse](02.编程/03.Java/11.软件/02.IDE/02.Eclipse.md)
- [vscode](02.编程/03.Java/11.软件/02.IDE/03.VsCode.md)

##### Java 监控诊断

> [监控/诊断](02.编程/03.Java/11.软件/03.监控诊断) 工具主要用于 Java 应用的运维。通过采集、分析、存储、可视化应用的有效数据，帮助开发者、使用者快速定位问题，找到性能瓶颈。

- [监控工具对比](02.编程/03.Java/11.软件/03.监控诊断/01.监控工具对比.md)
- [CAT](02.编程/03.Java/11.软件/03.监控诊断/02.CAT.md)
- [Zipkin](02.编程/03.Java/11.软件/03.监控诊断/03.Zipkin.md)
- [SkyWalking](02.编程/03.Java/11.软件/03.监控诊断/04.Skywalking.md)
- [Arthas](02.编程/03.Java/11.软件/03.监控诊断/05.Arthas.md)

#### Java 工具

##### Java IO

- [JSON 序列化](02.编程/03.Java/12.工具/01.IO/01.JSON序列化.md) - [fastjson](https://github.com/alibaba/fastjson)、[Jackson](https://github.com/FasterXML/jackson)、[Gson](https://github.com/google/gson)
- [二进制序列化](02.编程/03.Java/12.工具/01.IO/02.二进制序列化.md) - [Protobuf](https://developers.google.com/protocol-buffers)、[Thrift](https://thrift.apache.org/)、[Hessian](02.编程/http://hessian.caucho.com/)、[Kryo](https://github.com/EsotericSoftware/kryo)、[FST](https://github.com/RuedigerMoeller/fast-serialization)

##### JavaBean 工具

- [Lombok](02.编程/03.Java/12.工具/02.JavaBean/01.Lombok.md)
- [Dozer](02.编程/03.Java/12.工具/02.JavaBean/02.Dozer.md)

##### Java 模板引擎

- [Freemark](02.编程/03.Java/12.工具/03.模板引擎/01.Freemark.md)
- [Velocity](02.编程/03.Java/12.工具/03.模板引擎/02.Thymeleaf.md)
- [Thymeleaf](02.编程/03.Java/12.工具/03.模板引擎/03.Velocity.md)

##### Java 测试工具

- [Junit](02.编程/03.Java/12.工具/04.测试/01.Junit.md)
- [Mockito](02.编程/03.Java/12.工具/04.测试/02.Mockito.md)
- [Jmeter](02.编程/03.Java/12.工具/04.测试/03.Jmeter.md)
- [JMH](02.编程/03.Java/12.工具/04.测试/04.JMH.md)

##### 其他

- [Java 日志](02.编程/03.Java/12.工具/99.其他/01.Java日志.md)
- [Java 工具包](02.编程/03.Java/12.工具/99.其他/02.Java工具包.md)
- [Reflections](02.编程/03.Java/12.工具/99.其他/03.Reflections.md)
- [JavaMail](02.编程/03.Java/12.工具/99.其他/04.JavaMail.md)
- [Jsoup](02.编程/03.Java/12.工具/99.其他/05.Jsoup.md)
- [Thumbnailator](02.编程/03.Java/12.工具/99.其他/06.Thumbnailator.md)
- [Zxing](02.编程/03.Java/12.工具/99.其他/07.Zxing.md)

#### Java 框架

##### ORM

- [Mybatis 快速入门](02.编程/03.Java/13.框架/11.ORM/01.Mybatis快速入门.md)
- [Mybatis 原理](02.编程/03.Java/13.框架/11.ORM/02.Mybatis原理.md)
...
- [Shiro](02.编程/03.Java/13.框架/12.安全/01.Shiro.md)
- [SpringSecurity](02.编程/03.Java/13.框架/12.安全/02.SpringSecurity.md)

##### IO

- [Shiro](02.编程/03.Java/13.框架/13.IO/01.Netty.md)

##### 微服务

- [Dubbo](02.编程/03.Java/13.框架/14.微服务/01.Dubbo.md)
...
- [消息队列面试](02.编程/03.Java/14.中间件/01.MQ/01.消息队列面试.md)
- [消息队列基本原理](02.编程/03.Java/14.中间件/01.MQ/02.消息队列基本原理.md)
- [RocketMQ](02.编程/03.Java/14.中间件/01.MQ/03.RocketMQ.md)
- [ActiveMQ](02.编程/03.Java/14.中间件/01.MQ/04.ActiveMQ.md)
...
- [缓存面试题](02.编程/03.Java/14.中间件/02.缓存/01.缓存面试题.md)
- [Java 缓存中间件](02.编程/03.Java/14.中间件/02.缓存/02.Java缓存中间件.md)
- [Memcached 快速入门](02.编程/03.Java/14.中间件/02.缓存/03.Memcached.md)
- [Ehcache 快速入门](02.编程/03.Java/14.中间件/02.缓存/04.Ehcache.md)
- [Java 进程内缓存](02.编程/03.Java/14.中间件/02.缓存/05.Java进程内缓存.md)
- [Http 缓存](02.编程/03.Java/14.中间件/02.缓存/06.Http缓存.md)

##### 流量控制

- [Hystrix](02.编程/03.Java/14.中间件/03.流量控制/01.Hystrix.md)

## 设计

### 架构

- [系统架构面试总结](03.设计/01.架构/01.系统架构面试.md)
- [系统架构概述](03.设计/01.架构/02.系统架构概述.md)
- [系统高性能架构](03.设计/01.架构/03.系统高性能架构.md)
- [系统高可用架构](03.设计/01.架构/04.系统高可用架构.md)
- [系统伸缩性架构](03.设计/01.架构/05.系统伸缩性架构.md)
- [系统扩展性架构](03.设计/01.架构/06.系统扩展性架构.md)
- [系统安全性架构](03.设计/01.架构/07.系统安全性架构.md)
- [大型系统核心技术](03.设计/01.架构/08.大型系统核心技术.md)
- [领域驱动设计](03.设计/01.架构/09.领域驱动设计.md)
