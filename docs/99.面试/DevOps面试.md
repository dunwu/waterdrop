...
> **题库统计**：共收录 **127** 道面试题。简单 **24** 题（18.9%），中等 **94** 题（74.0%），困难 **9** 题（7.1%）
...
| DevOps         | 什么是 DevOps？                                                | 简单   | ⭐⭐       |        |      |
| DevOps         | 列举一下 DevOps 各环节的主流工具？                             | 中等   | ⭐⭐       |        |      |
| DevOps         | 什么是 Git 的 fork 命令？它和 clone 命令有什么区别？           | 中等   | ⭐⭐       |        |      |
| DevOps         | 什么是 Git 的 cherry-pick？                                    | 中等   | ⭐⭐       |        |      |
| DevOps         | Linux 中的硬链接和软连接是什么，二者有什么区别？               | 中等   | ⭐⭐       |        |      |
| DevOps         | CC 攻击是什么？什么叫 DDOS 攻击？什么是网站数据库注入？        | 中等   | ⭐⭐       |        |      |
| DevOps         | 如何在 Linux 中查看系统资源使用情况？比如内存、CPU、网络端口。 | 中等   | ⭐⭐       |        |      |
