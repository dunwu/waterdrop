...
tags:
  - 面试
permalink: /pages/c1b7fc82/
---

# JavaCore 面试

> **题库统计**：共收录 **291** 道面试题，覆盖 Java 基础 / 容器 / 并发 / JVM 四大板块。其中简单题 **83** 道（28.5%），中等题 **161** 道（55.3%），困难题 **47** 道（16.2%）。整体难度呈正态分布，中等题占比过半，适合初中级工程师系统备战；困难题集中在并发和 JVM 模块，适合高级岗位深度考察。
...
- 难易度：| 简单 **53** 题 | 中等 **52** 题 | 困难 **3** 题 |
- 重要度：| 一星 **17** 题 | 二星 **35** 题 | 三星 **39** 题 | 四星 **14** 题 | 五星 **3** 题 |
...
| Java 基础语法 | Java 中 `static` 关键字有什么用？                            | 简单   | ⭐⭐       |   ✅   |      |
| Java 基础语法 | `transient` 关键字有什么用？                                 | 中等   | ⭐⭐       |   ✅   |      |
| Java 基础语法 | `native` 关键字有什么用？                                    | 简单   | ⭐         |   ✅   |      |
| Java 基础语法 | 移位操作中 `<<`、`>>`、`>>>` 有什么区别？                    | 中等   | ⭐         |   ✅   |      |
| Java 基础语法 | 静态变量、成员变量、局部变量的区别？                         | 简单   | ⭐⭐       |   ✅   |      |
| Java 基础语法 | 为什么成员变量有默认值？                                     | 简单   | ⭐⭐       |   ✅   |      |
| Java 基础语法 | 字符型常量和字符串常量的区别？                               | 简单   | ⭐         |   ✅   |      |
| Java 基础语法 | Java 方法有哪些类型？                                        | 简单   | ⭐         |   ✅   |      |
| Java 基础语法 | 静态方法和实例方法有何不同？                                 | 简单   | ⭐⭐       |   ✅   |      |
| Java 基础语法 | 重载和重写有什么区别？                                       | 简单   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 基础语法 | 什么是可变长参数？                                           | 简单   | ⭐⭐       |   ✅   |      |
| Java 基础语法 | Java 中有哪些常见的语法糖？                                  | 中等   | ⭐         |   ✅   |      |
| Java 数据类型 | Java 是否只支持值传递？                                      | 简单   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 数据类型 | Java 有哪些值类型？                                          | 简单   | ⭐⭐       |   ✅   |      |
| Java 数据类型 | 什么是装箱、拆箱？                                           | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 数据类型 | 包装类型的缓存机制了解么？                                   | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 数据类型 | 比较包装类型为什么不能用 ==？                                | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 数据类型 | 为什么浮点数运算的时候会有精度丢失的风险？                   | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 数据类型 | 如何解决浮点数运算的精度丢失问题？                           | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 数据类型 | 超过 long 整型的数据应该如何表示？                           | 简单   | ⭐         |   ✅   |      |
| Java 数据类型 | 自动装箱拆箱有哪些陷阱？                                     | 中等   | ⭐⭐       |   ✅   |      |
| Java 数据类型 | Java 是如何处理整数溢出的？                                  | 中等   | ⭐⭐       |   ❌   |      |
| Java 异常     | Exception 和 Error 有什么区别？                              | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 异常     | Checked Exception 和 Unchecked Exception 有什么区别？        | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 异常     | Throwable 类常用方法有哪些？                                 | 简单   | ⭐         |   ✅   |      |
| Java 异常     | try-catch-finally 如何使用？                                 | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 异常     | finally 中的代码一定会执行吗？                               | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 异常     | 如何使用 `try-with-resources` 代替`try-catch-finally`？      | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 异常     | NoClassDefFoundError 和 ClassNotFoundException 有什么区别    | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 异常     | 异常使用有哪些需要注意的地方？                               | 简单   | ⭐⭐       |   ✅   |      |
| Java 异常     | Java 中 final、finally 和 finalize 有什么区别？              | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 异常     | `instanceof` 关键字的作用？                                  | 简单   | ⭐⭐       |   ✅   |      |
...
| String        | String#intern 方法有什么用？                                 | 简单   | ⭐⭐⭐     |   ✅   |      |
...
| Java 泛型     | Java 泛型的作用是什么？                                      | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 泛型     | 什么是 Java 泛型的上下界限定符？                             | 中等   | ⭐⭐⭐     |   ⚠️   |      |
| Java 泛型     | 泛型擦除的作用是什么？                                       | 中等   | ⭐⭐⭐⭐   |   ⚠️   |      |
| Java 反射     | 什么是反射？反射有什么作用？                                 | 简单   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 反射     | 反射有什么优缺点？                                           | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 反射     | 什么是 Java 中的动态代理？                                   | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 反射     | JDK 动态代理和 CGLIB 动态代理有什么区别？                    | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 注解     | Java 中的注解原理是什么？                                    | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 注解     | 如何自定义注解并使用注解处理器？                             | 中等   | ⭐⭐       |   ⚠️   |      |
...
| Java 新特性   | Java 8 的 Optional 的正确使用方式？                          | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 新特性   | Java 8 的 Lambda 表达式和函数式接口是什么？                  | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 新特性   | Java 8 的 Stream API 的核心操作有哪些？                      | 困难   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 新特性   | Java 8 的接口的默认方法和静态方法是什么？                    | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 新特性   | Java 8 的 java.time API 解决了什么问题？                     | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 新特性   | Java 9 引入的模块化系统（JPMS）有什么用？                    | 中等   | ⭐         |   ❌   |      |
| Java 新特性   | Java 11 的 var 局部变量类型推断怎么用？有什么限制？          | 中等   | ⭐⭐       |   ⚠️   |      |
| Java 新特性   | Java 11 的 HTTP Client API 有什么特点？                      | 中等   | ⭐⭐       |   ❌   |      |
| Java 新特性   | Java 11 的字符串 API 有哪些增强？                            | 中等   | ⭐         |   ❌   |      |
| Java 新特性   | Java 11 对 GC 有哪些重要更新？                               | 中等   | ⭐⭐       |   ⚠️   |      |
| Java 新特性   | Java 14 对 switch 有哪些增强？                               | 中等   | ⭐⭐       |   ⚠️   |      |
| Java 新特性   | Java 16 的 Record（记录类）有什么用？                        | 中等   | ⭐⭐⭐     |   ⚠️   |      |
...
| Java 新特性   | Java 17 的 switch 表达式增强是什么？                         | 中等   | ⭐⭐⭐     |   ⚠️   |      |
| Java 新特性   | Java 21 的 switch 模式匹配有什么增强？                       | 中等   | ⭐⭐⭐     |   ⚠️   |      |
...
- 重要度：| 一星 **4** 题 | 二星 **13** 题 | 三星 **19** 题 | 四星 **6** 题 | 五星 **3** 题 |
...
| Java 容器简介   | 什么是序列集合（Sequenced Collections）？              | 中等   | ⭐⭐       |   ⚠️   |      |
...
| List            | fail-fast 和 fail-safe 机制有什么区别？                | 中等   | ⭐⭐⭐     |   ⚠️   |      |
...
| List            | Vector 和 Stack 为什么被弃用？                         | 中等   | ⭐⭐       |   ✅   |      |
| Map             | 什么是 Hash 碰撞？如何解决 Hash 碰撞？                 | 简单   | ⭐⭐⭐     |   ✅   |      |
| Map             | HashMap 和 Hashtable 有什么区别？                      | 中等   | ⭐⭐⭐     |   ✅   |      |
| Map             | ConcurrentHashMap 和 Hashtable 有什么区别？            | 中等   | ⭐⭐⭐     |   ✅   |      |
| Map             | 对比一下 HashMap 和 HashSet？                          | 中等   | ⭐⭐⭐     |   ✅   |      |
| Map             | HashMap、TreeMap、LinkedHashMap 有什么区别？           | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
...
| Map             | ConcurrentHashMap 为什么 key 和 value 不能为 null？    | 中等   | ⭐⭐⭐     |   ✅   |      |
...
| Map             | IdentityHashMap 和 HashMap 有什么区别？                | 中等   | ⭐⭐       |   ⚠️   |      |
| Map             | EnumMap 和 EnumSet 的实现原理是什么？                  | 中等   | ⭐⭐       |   ❌   |      |
| Stream API      | Stream API 的中间操作和终端操作有什么区别？            | 中等   | ⭐⭐⭐     |   ✅   |      |
| Stream API      | 什么是短路操作？                                       | 中等   | ⭐⭐       |   ⚠️   |      |
| Stream API      | 并行流（Parallel Stream）的原理和注意事项？            | 中等   | ⭐⭐⭐     |   ✅   |      |
| Stream API      | Collectors 工具类有哪些常用方法？                      | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 容器工具类 | 排序操作                                               | 简单   | ⭐         |   ✅   |      |
| Java 容器工具类 | 查找，替换操作                                         | 简单   | ⭐         |   ✅   |      |
| Java 容器工具类 | 同步控制                                               | 简单   | ⭐         |   ✅   |      |
...
- 难易度：| 简单 **13** 题 | 中等 **63** 题 | 困难 **20** 题 |
- 重要度：| 一星 **3** 题 | 二星 **20** 题 | 三星 **34** 题 | 四星 **22** 题 | 五星 **17** 题 |
...
| 并发简介          | 并发一定比串行更快吗？                                                                                    | 简单   | ⭐⭐       |   ✅   |      |
| 并发简介          | 什么是并发安全？有哪些线程不安全的情况？                                                                  | 简单   | ⭐⭐⭐     |   ✅   |      |
| 并发简介          | 为什么会有并发安全问题？                                                                                  | 中等   | ⭐⭐⭐     |   ✅   |      |
| 并发简介          | 哪些场景需要额外注意并发安全问题？                                                                        | 中等   | ⭐⭐       |   ✅   |      |
| 并发简介          | 什么是死锁？如何发现死锁？如何避免死锁？                                                                  | 困难   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| 并发简介          | 什么是活锁？如何避免活锁？                                                                                | 中等   | ⭐⭐       |   ❌   |      |
| 并发简介          | 什么是饥饿问题？如何避免饥饿？                                                                            | 中等   | ⭐⭐       |   ❌   |      |
| 并发简介          | 简单介绍一下 Java 并发编程？                                                                              | 简单   | ⭐         |   ✅   |      |
| Java 内存模型     | 什么是 Java 内存模型？                                                                                    | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
...
| Java 内存模型     | final 关键字可以保证线程的可见性吗？                                                                      | 中等   | ⭐⭐       |   ✅   |      |
| Java 线程         | Java 线程生命周期有哪些状态？状态之间如何切换？                                                           | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 线程         | Java 中，创建线程有几种方式？                                                                             | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 线程         | 可以直接调用 `Thread.run()` 方法么？                                                                      | 简单   | ⭐⭐⭐     |   ✅   |      |
| Java 线程         | `Thread.start()` 的内部原理是什么？                                                                       | 中等   | ⭐⭐       |   ✅   |      |
| Java 线程         | 如何正确停止 Java 线程？                                                                                  | 中等   | ⭐⭐⭐     |   ✅   |      |
...
| Java 线程         | Java 线程之间如何进行通信？                                                                               | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 线程         | 高优先级的 Java 线程一定先执行吗？                                                                        | 简单   | ⭐⭐       |   ✅   |      |
| Java 线程         | 什么是守护线程？用户线程和守护线程有什么区别？                                                            | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 线程         | 什么是 FutureTask？它的原理是什么？                                                                       | 中等   | ⭐⭐⭐     |   ❌   |      |
| 虚拟线程          | Java 传统线程和虚拟线程有什么区别？                                                                       | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| 虚拟线程          | 虚拟线程的实现原理是什么？                                                                                | 困难   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| 虚拟线程          | 虚拟线程需要池化吗？为什么？                                                                              | 中等   | ⭐⭐⭐     |   ✅   |      |
| 虚拟线程          | 虚拟线程的 Pinning 是什么？如何避免？                                                                     | 困难   | ⭐⭐⭐⭐   |   ✅   |      |
| 虚拟线程          | 虚拟线程环境下 ThreadLocal 有什么问题？ScopedValue 如何解决？                                             | 中等   | ⭐⭐⭐     |   ❌   |      |
| 虚拟线程          | 虚拟线程的结构化并发是什么？                                                                              | 困难   | ⭐⭐⭐     |   ❌   |      |
| Java 锁           | Java 中，根据不同维度划分，锁有哪些分类？                                                                 | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 锁           | 悲观锁和乐观锁有什么区别？                                                                                | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 锁           | 公平锁和非公平锁有什么区别？                                                                              | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 锁           | AQS 的实现原理是什么？                                                                                    | 困难   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 锁           | synchronized 和 ReentrantLock 有什么区别？                                                                | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 锁           | ReentrantLock 的实现原理是什么？                                                                          | 困难   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 锁           | ReentrantReadWriteLock 的实现原理是什么？                                                                 | 困难   | ⭐⭐⭐     |   ✅   |      |
| Java 锁           | StampedLock 的实现原理是什么？                                                                            | 困难   | ⭐⭐       |   ✅   |      |
| Java 锁           | Condition 的原理是什么？与 Object.wait/notify 有什么区别？                                                | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 锁           | AQS 的 CLH 队列与原始 CLH 队列有什么区别？                                                                | 困难   | ⭐⭐       |   ✅   |      |
| CAS 与原子类      | 什么是 CAS？CAS 的实现原理是什么？                                                                        | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| CAS 与原子类      | CAS 算法存在哪些问题？                                                                                    | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| CAS 与原子类      | LongAdder 的原理是什么？为什么高并发下比 AtomicLong 快？                                                  | 困难   | ⭐⭐⭐     |   ✅   |      |
| CAS 与原子类      | Java 中支持哪些原子类？                                                                                   | 中等   | ⭐⭐       |   ✅   |      |
| ThreadLocal       | 什么是 ThreadLocal？                                                                                      | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| ThreadLocal       | `ThreadLocal` 的原理是什么？                                                                              | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| ThreadLocal       | 如何解决 `ThreadLocal` 内存泄漏问题？                                                                     | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| ThreadLocal       | InheritableThreadLocal 的实现原理是什么？                                                                 | 中等   | ⭐⭐⭐     |   ✅   |      |
| ThreadLocal       | TransmittableThreadLocal 是什么？解决了什么问题？                                                         | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 线程池       | 为什么要用线程池？                                                                                        | 简单   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 线程池       | Java 创建线程池有哪些方式？                                                                               | 简单   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 线程池       | Java 线程池有哪些核心参数？各有什么作用？                                                                 | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 线程池       | Java 线程池的工作原理是什么？                                                                             | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 线程池       | Java 线程池的核心线程会被回收吗？                                                                         | 简单   | ⭐⭐⭐     |   ✅   |      |
...
| Java 线程池       | Java 线程池中 shutdown 与 shutdownNow 的区别是什么？                                                      | 中等   | ⭐⭐⭐     |   ✅   |      |
...
| Java 并发同步工具 | CyclicBarrier 的工作原理是什么？                                                                          | 中等   | ⭐⭐⭐     |   ❌   |      |
...
| Java 并发分工工具 | CompletableFuture 有哪些用法？                                                                            | 中等   | ⭐⭐⭐⭐   |   ❌   |      |
| Java 并发分工工具 | CompletableFuture 的工作原理是什么？                                                                      | 困难   | ⭐⭐⭐     |   ❌   |      |
...
| Java 并发容器     | Java 线程安全的集合有哪些？                                                                               | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| Java 并发容器     | ConcurrentLinkedQueue 的原理是什么？                                                                      | 中等   | ⭐⭐       |   ❌   |      |
...
- 重要度：| 一星 **1** 题 | 二星 **11** 题 | 三星 **9** 题 | 四星 **17** 题 | 五星 **4** 题 |
...
| 类加载   | 什么是类加载器？                                                              | 困难   | ⭐⭐⭐⭐   |   ✅   |      |
| 类加载   | 有哪些场景破坏了双亲委派模型？                                                | 困难   | ⭐⭐⭐⭐   |   ⚠️   |      |
| JVM 内存 | JVM 的内存区域是如何划分的？                                                  | 困难   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| JVM 内存 | JVM 产生 OOM 有哪几种情况？                                                   | 困难   | ⭐⭐⭐⭐   |   ✅   |      |
| JVM 内存 | 字符串常量池有什么用？                                                        | 简单   | ⭐⭐⭐     |   ✅   |      |
| JVM 内存 | 为什么 Java 8 移除了永久代（PermGen）并引入了元空间（Metaspace）？            | 困难   | ⭐⭐⭐     |   ✅   |      |
| 字节码   | Java 是编译型语言还是解释型语言？                                             | 中等   | ⭐⭐       |   ✅   |      |
...
| 垃圾收集 | 为什么不建议使用 finalize()？                                                 | 中等   | ⭐⭐       |   ✅   |      |
| 垃圾收集 | 什么是三色标记？如何解决漏标问题？                                            | 困难   | ⭐⭐⭐⭐   |   ❌   |      |
| 垃圾收集 | 什么是安全点和安全区域？                                                      | 中等   | ⭐⭐⭐⭐   |   ❌   |      |
| 垃圾收集 | Java 对象有哪些引用类型？                                                     | 中等   | ⭐⭐⭐     |   ✅   |      |
| 垃圾收集 | Java 中有哪些垃圾回收算法？                                                   | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| 垃圾收集 | Java 中常见的垃圾收集器有哪些？                                               | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| 垃圾收集 | Java 中的 Young GC、Old GC、Full GC 和 Mixed GC 的区别是什么？                | 困难   | ⭐⭐⭐⭐   |   ❌   |      |
| 垃圾收集 | JVM 的内存分配策略是怎样的？对象何时晋升老年代？                              | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| 垃圾收集 | Java 的 CMS 垃圾回收流程是怎样的？                                            | 困难   | ⭐⭐⭐     |   ⚠️   |      |
| 垃圾收集 | Java 的 G1 垃圾回收流程是怎样的？                                             | 困难   | ⭐⭐⭐⭐   |   ❌   |      |
| 垃圾收集 | Java 的 ZGC 垃圾回收流程是怎样的？                                            | 困难   | ⭐⭐⭐⭐   |   ❌   |      |
| 垃圾收集 | Java 的 Shenandoah 垃圾回收流程是怎样的？                                     | 困难   | ⭐⭐       |   ❌   |      |
| 垃圾收集 | JVM 垃圾回收时产生的 concurrent mode failure 的原因是什么？                   | 困难   | ⭐⭐       |   ❌   |      |
| JVM 调优 | JDK 内置了哪些工具？                                                          | 简单   | ⭐⭐⭐     |   ✅   |      |
| JVM 调优 | 常用的 JVM 配置参数有哪些？                                                   | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| JVM 调优 | 如何在 Java 中进行内存泄漏分析？                                              | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| JVM 调优 | 如何对 Java 的垃圾回收进行调优？                                              | 中等   | ⭐⭐⭐     |   ✅   |      |
| JVM 调优 | Java 应用的内存持续性增长，但是监控显示堆内存没有什么变化，可能的原因有哪些？ | 中等   | ⭐⭐       |   ❌   |      |
| JVM 调优 | 线上 CPU 飙高（100%），如何快速排查定位？                                     | 困难   | ⭐⭐⭐⭐   |   ⚠️   |      |
