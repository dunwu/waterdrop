...
| Java 异常     | 如何使用 `try-with-resources` 代替`try-catch-finally`？      | 简单   | ⭐⭐⭐     |   ⚠️   |      |
| Java 异常     | NoClassDefFoundError 和 ClassNotFoundException 有什么区别    | 简单   | ⭐⭐       |   ✅   |      |
| Java 异常     | 异常使用有哪些需要注意的地方？                               | 简单   | ⭐⭐       |   ✅   |      |
| Java 异常     | Java 中 final、finally 和 finalize 有什么区别？              | 中等   | ⭐⭐⭐     |   ⚠️   |      |
...
| Map             | HashMap 底层实现原理是什么？                           | 困难   | ⭐⭐⭐⭐⭐ |   ✅   | L2   |
| Map             | JDK 1.8 对 HashMap 做了哪些改动？                      | 困难   | ⭐⭐⭐⭐   |   ✅   | L2   |
...
| Java 无锁         | Java 中支持哪些原子类？                                                                                   | 中等   | ⭐⭐       |   ✅   |      |
| Java 无锁         | 什么是 ThreadLocal？                                                                                      | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 无锁         | `ThreadLocal` 的原理是什么？                                                                              | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 无锁         | 如何解决 `ThreadLocal` 内存泄漏问题？                                                                     | 中等   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 无锁         | InheritableThreadLocal 的实现原理是什么？                                                                 | 中等   | ⭐⭐⭐     |   ⚠️   |      |
| Java 无锁         | TransmittableThreadLocal 是什么？解决了什么问题？                                                         | 中等   | ⭐⭐⭐     |   ⚠️   |      |
| Java 无锁         | 虚拟线程环境下 ThreadLocal 有什么问题？ScopedValue 如何解决？                                             | 中等   | ⭐⭐⭐     |   ⚠️   |      |
...
| Java 并发分工工具 | 虚拟线程的 Pinning 是什么？如何避免？                                                                     | 困难   | ⭐⭐⭐⭐   |   ⚠️   |      |
| Java 并发分工工具 | CompletableFuture 有哪些用法？                                                                            | 中等   | ⭐⭐⭐⭐   |   ⚠️   |      |
...
| Java 容器         | ConcurrentHashMap 的实现原理是什么？                                                                      | 困难   | ⭐⭐⭐⭐⭐ |   ✅   |      |
| Java 容器         | CopyOnWriteArrayList 的原理是什么？适用什么场景？                                                         | 中等   | ⭐⭐⭐     |   ✅   |      |
| Java 容器         | ConcurrentLinkedQueue 的原理是什么？                                                                      | 中等   | ⭐⭐       |   ❌   |      |
...
| 垃圾收集 | Java 中的 Young GC、Old GC、Full GC 和 Mixed GC 的区别是什么？                | 困难   | ⭐⭐⭐     |   ⚠️   |      |
| 垃圾收集 | JVM 的内存分配策略是怎样的？对象何时晋升老年代？                              | 中等   | ⭐⭐⭐⭐   |   ✅   |      |
| 垃圾收集 | Java 的 CMS 垃圾回收流程是怎样的？                                            | 困难   | ⭐⭐⭐     |   ⚠️   |      |
| 垃圾收集 | Java 的 G1 垃圾回收流程是怎样的？                                             | 困难   | ⭐⭐⭐⭐   |   ⚠️   |      |
