...
> **题库统计**：共收录 **153** 道面试题，覆盖 JavaWeb / Spring / MyBatis / Netty 四大板块。其中简单题 **53** 道（34.6%），中等题 **89** 道（58.2%），困难题 **11** 道（7.2%）。整体以中等难度为主，简单题集中在 Spring 和 JavaWeb 基础题，困难题集中在 Spring 核心原理与 Netty 模块，适合中高级岗位深度考察。
...
| Servlet   | 过滤器(Filter)、拦截器(Interceptor)、AOP 的区别？ | 中等   | ⭐⭐⭐⭐ |   ⚠️   |      |
| Web 会话  | Cookie 和 Session 的区别是什么？                  | 中等   | ⭐⭐⭐⭐ |   ⚠️   |      |
| Web 会话  | 如果禁用了 Cookie 怎么办？                        | 中等   | ⭐⭐     |        |      |
| Web 会话  | 分布式 Session 有哪些实现方案？                   | 中等   | ⭐⭐⭐   |        |      |
| Web 会话  | 什么是 JWT？JWT 的原理和结构是什么？              | 中等   | ⭐⭐⭐   |   ✅   |      |
| Web 会话  | JWT Token 如何续签？如何解决无法主动失效的问题？  | 中等   | ⭐⭐     |        |      |
...
- 难易度：| 简单 **36** 题 | 中等 **46** 题 | 困难 **3** 题 |
- 重要度：| 一星 **8** 题 | 二星 **55** 题 | 三星 **8** 题 | 四星 **8** 题 | 五星 **6** 题 |
...
| Spring | Spring 和 Spring MVC 之间是什么关系？                         | 简单   | ⭐⭐       |   ⚠️   |      |
| Spring | Spring、SpringBoot、SpringCloud 之间是什么关系？              | 简单   | ⭐⭐       |        |      |
| Spring | Spring 中用到了哪些设计模式？                                 | 中等   | ⭐⭐⭐⭐   |   ⚠️   |      |
...
| Spring | 什么是自动装配？                                              | 中等   | ⭐⭐       |        |      |
| Spring | 什么是 IoC？什么是依赖注入？什么是 Spring IoC？               | 简单   | ⭐⭐⭐⭐   |   ⚠️   |      |
...
| Spring | BeanFactory 和 ApplicationContext 有什么区别？                | 简单   | ⭐⭐⭐     |   ⚠️   |      |
| Spring | BeanFactory 和 FactoryBean 有什么区别？                       | 简单   | ⭐⭐       |        |      |
| Spring | @Autowired、@Resource、@Inject 有什么区别？                   | 中等   | ⭐⭐⭐     |   ⚠️   |      |
| Spring | @Configuration 和 @Component 有什么区别？                     | 中等   | ⭐⭐       |        |      |
| Spring | Spring 如何解决循环依赖？                                     | 困难   | ⭐⭐⭐⭐⭐ |   ⚠️   |      |
| Spring | Spring 解决循环依赖为什么一定要用三级缓存？                   | 困难   | ⭐⭐⭐⭐⭐ |   ❌   |      |
| Spring | 什么是 AOP？                                                  | 简单   | ⭐⭐⭐⭐   |   ⚠️   |      |
| Spring | Spring AOP 有哪些实现方式？                                   | 中等   | ⭐⭐⭐⭐⭐ |   ⚠️   |      |
| Spring | Spring AOP 和 AspectJ 有什么区别？                            | 中等   | ⭐⭐       |   ⚠️   |      |
| Spring | Spring AOP 在哪些场景下会失效？                               | 中等   | ⭐⭐⭐⭐   |   ⚠️   |      |
...
- 难易度：| 简单 **1** 题 | 中等 **12** 题 | 困难 **2** 题 |
- 重要度：| 一星 **6** 题 | 二星 **3** 题 | 三星 **3** 题 | 四星 **2** 题 | 五星 **1** 题 |
...
| 分类       | 题目                                             | 难易度 | 重要度     | 掌握度 | 评估 |
| :--------- | :----------------------------------------------- | :----- | :--------- | :----: | ---- |
| SpringBoot | 什么是 SpringBoot？                              | 简单   | ⭐⭐       |        |      |
| SpringBoot | SpringBoot 是如何实现自动配置的？                | 中等   | ⭐⭐⭐⭐⭐ |   ❌   |      |
| SpringBoot | SpringBoot 是如何通过 main 方法启动 web 项目的？ | 中等   | ⭐         |        |      |
| SpringBoot | SpringBoot 的启动流程是如何设计的？              | 困难   | ⭐⭐⭐⭐   |   ❌   |      |
| SpringBoot | 如何自定义一个 starter 包？                      | 困难   | ⭐⭐⭐⭐   |   ❌   |      |
| SpringBoot | SpringBoot 有哪些条件注解？                      | 中等   | ⭐         |        |      |
| SpringBoot | SpringBoot 支持哪些内嵌 Web 容器？如何切换？     | 中等   | ⭐         |        |      |
| SpringBoot | SpringBoot 是如何内嵌 Tomcat 的？                | 中等   | ⭐⭐       |        |      |
| SpringBoot | SpringBoot 的配置文件优先级是怎样的？            | 中等   | ⭐⭐       |        |      |
| SpringBoot | @ConfigurationProperties 和 @Value 有什么区别？  | 中等   | ⭐⭐⭐     |        |      |
| SpringBoot | SpringBoot Actuator 是什么？有哪些核心端点？     | 中等   | ⭐         |        |      |
| SpringBoot | SpringBoot 3.x 有哪些重要新特性？                | 中等   | ⭐⭐⭐     |        |      |
| SpringBoot | SpringBoot 启动慢的原因有哪些？如何优化？        | 中等   | ⭐         |        |      |
| SpringBoot | SpringBoot 如何解决 jar 包冲突？                 | 中等   | ⭐         |        |      |
| SpringBoot | SpringBoot 如何实现优雅停机？                    | 中等   | ⭐⭐⭐     |   ❌   |      |
...
- 难易度：| 简单 **12** 题 | 中等 **30** 题 | 困难 **2** 题 |
- 重要度：| 一星 **4** 题 | 二星 **30** 题 | 三星 **9** 题 | 四星 **1** 题 |
...
| 分类        | 题目                                            | 难易度 | 重要度   | 掌握度 | 评估 |
| :---------- | :---------------------------------------------- | :----- | :------- | :----: | ---- |
| SpringCloud | Spring Cloud 有哪些核心组件？                   | 中等   | ⭐⭐⭐   |        |      |
| SpringCloud | Spring Cloud 的优缺点有哪些？                   | 中等   | ⭐⭐     |        |      |
| SpringCloud | Spring Boot 和 Spring Cloud 之间的区别？        | 中等   | ⭐⭐     |        |      |
| SpringCloud | 什么是 Seata？                                  | 简单   | ⭐⭐     |        |      |
| SpringCloud | Seata 支持哪些模式的分布式事务？                | 中等   | ⭐⭐⭐   |        |      |
| SpringCloud | 了解 Seata 的实现原理吗？                       | 中等   | ⭐⭐     |        |      |
| SpringCloud | Seata 的事务回滚是怎么实现的？                  | 中等   | ⭐⭐     |        |      |
| SpringCloud | Spring Cloud 有哪些注册中心？                   | 简单   | ⭐⭐     |        |      |
| SpringCloud | 什么是 Eureka？                                 | 简单   | ⭐⭐     |        |      |
| SpringCloud | Eureka 的实现原理说一下？                       | 中等   | ⭐⭐     |        |      |
| SpringCloud | Spring Cloud 如何实现服务注册？                 | 中等   | ⭐⭐     |        |      |
| SpringCloud | Consul 是什么？                                 | 简单   | ⭐⭐     |        |      |
| SpringCloud | Nacos 中的 Namespace 是什么？                   | 简单   | ⭐⭐     |        |      |
| SpringCloud | 什么是 Hystrix？                                | 简单   | ⭐⭐     |        |      |
| SpringCloud | Sentinel 是怎么实现限流的？                     | 中等   | ⭐⭐⭐   |        |      |
| SpringCloud | Sentinel 是怎么实现集群限流的？                 | 中等   | ⭐⭐     |        |      |
| SpringCloud | Sentinel 是如何实现熔断降级的？                 | 中等   | ⭐⭐⭐   |   ❌   |      |
| SpringCloud | Sentinel 与 Hystrix 的区别是什么？              | 中等   | ⭐⭐     |        |      |
| SpringCloud | 什么是服务雪崩？如何做全链路防护？              | 中等   | ⭐⭐⭐⭐ |   ❌   |      |
| SpringCloud | Spring Cloud 可以选择哪些 API 网关？            | 简单   | ⭐⭐     |        |      |
| SpringCloud | 什么是 Spring Cloud Gateway？                   | 简单   | ⭐⭐     |        |      |
| SpringCloud | 你项目里为什么选择 Gateway 作为网关？           | 中等   | ⭐⭐     |        |      |
| SpringCloud | Dubbo 和 Spring Cloud Gateway 有什么区别？      | 中等   | ⭐⭐     |        |      |
| SpringCloud | 什么是 Spring Cloud Zuul？                      | 简单   | ⭐⭐     |        |      |
| SpringCloud | 你知道 Nacos 配置中心的实现原理吗？             | 中等   | ⭐⭐⭐   |   ❌   |      |
| SpringCloud | Spring Cloud Config 是什么？                    | 简单   | ⭐⭐     |        |      |
| SpringCloud | Spring Cloud 支持哪些链路追踪方案？             | 中等   | ⭐⭐     |        |      |
| SpringCloud | 什么是 Feign？                                  | 简单   | ⭐⭐     |        |      |
| SpringCloud | Feign 是如何实现负载均衡的？                    | 中等   | ⭐⭐     |        |      |
| SpringCloud | 为什么 Feign 第一次调用耗时很长？               | 中等   | ⭐⭐     |        |      |
| SpringCloud | Feign 和 OpenFeign 有什么区别？                 | 中等   | ⭐⭐     |        |      |
| SpringCloud | Feign 和 Dubbo 有什么区别？                     | 简单   | ⭐⭐     |        |      |
| SpringCloud | 单体架构和微服务架构有什么区别？                | 中等   | ⭐⭐     |        |      |
| SpringCloud | 微服务如何拆分？                                | 中等   | ⭐⭐⭐   |        |      |
| SpringCloud | SpringCloud 和 SpringCloud Alibaba 有什么区别？ | 中等   | ⭐⭐     |        |      |
| SpringCloud | Eureka 的自我保护机制是什么？                   | 中等   | ⭐       |        |      |
| SpringCloud | Nacos 的 AP 和 CP 模式如何切换？                | 中等   | ⭐⭐⭐   |        |      |
| SpringCloud | OpenFeign 的工作原理是什么？                    | 困难   | ⭐⭐⭐   |        |      |
| SpringCloud | OpenFeign 如何配置超时和重试？                  | 中等   | ⭐       |        |      |
| SpringCloud | Spring Cloud Gateway 的工作原理是什么？         | 困难   | ⭐⭐⭐   |        |      |
| SpringCloud | Gateway 如何实现动态路由？                      | 中等   | ⭐⭐     |        |      |
| SpringCloud | Gateway 过滤器链的执行顺序是怎样的？            | 中等   | ⭐⭐     |        |      |
| SpringCloud | Sleuth + Zipkin 的工作原理是什么？              | 中等   | ⭐       |        |      |
| SpringCloud | SkyWalking 和 Zipkin 有什么区别？               | 中等   | ⭐       |        |      |
...
- 重要度：| 一星 **6** 题 | 二星 **10** 题 | 三星 **6** 题 | 四星 **5** 题 |
...
- 难易度：| 简单 **1** 题 | 中等 **10** 题 | 困难 **5** 题 |
- 重要度：| 一星 **1** 题 | 二星 **5** 题 | 三星 **10** 题 |
...
| Netty 组件 | Netty 的 EventLoop 是如何工作的？            | 中等   | ⭐⭐⭐ |   ❌   |      |
