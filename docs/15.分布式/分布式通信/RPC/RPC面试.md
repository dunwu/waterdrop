...
序列化协议直接影响 RPC 的性能、兼容性和安全性。下面从多个维度对主流序列化协议进行深度对比。
...
> 扩展阅读：[深入理解 Java 序列化](https://dunwu.github.io/waterdrop/pages/ce9efc62/)
...
> 反射+动态代理更多详情可以参考：[深入理解 Java 反射和动态代理](https://dunwu.github.io/waterdrop/pages/e058816d/)
...
> 负载均衡详情可以参考：[负载均衡基本原理](https://dunwu.github.io/waterdrop/pages/23491030/)
