...
- [Java 基础语法特性](基础特性/[JavaCore]基础语法.md) - 关键词：`强类型`、`访问修饰符`、`final`、`操作符`、`序列化`
- [Java 基本数据类型](基础特性/[JavaCore]数据类型.md) - 关键词：`包装类`、`装箱拆箱`、`缓存机制`、`BigDecimal`、`精度丢失`
- [Java 面向对象](基础特性/[JavaCore]面向对象.md) - 关键词：`封装`、`继承`、`多态`、`接口`、`抽象类`
- [Java 方法](基础特性/[JavaCore]方法.md) - 关键词：`值传递`、`重载`、`覆写`、`static`、`可变参数`
- [Java 数组](基础特性/[JavaCore]数组.md) - 关键词：`引用类型`、`多维数组`、`Arrays`、`长度固定`、`下标`
- [Java 枚举](基础特性/[JavaCore]枚举.md) - 关键词：`enum`、`EnumSet`、`EnumMap`、`单例模式`、`状态机`
- [Java 控制语句](基础特性/[JavaCore]控制语句.md) - 关键词：`if`、`switch`、`while`、`for`、`break`
- [Java 异常](基础特性/[JavaCore]异常.md) - 关键词：`Throwable`、`RuntimeException`、`try-catch-finally`、`Checked Exception`、`异常链`
- [Java 泛型](基础特性/[JavaCore]泛型.md) - 关键词：`类型擦除`、`通配符`、`PECS`、`泛型类`、`类型边界`
- [Java 反射](基础特性/[JavaCore]反射.md) - 关键词：`Class`、`invoke`、`动态代理`、`CGLIB`、`InvocationHandler`
- [Java 注解](基础特性/[JavaCore]注解.md) - 关键词：`元注解`、`@Retention`、`@Target`、`自定义注解`、`反射解析`
- [Java String 类型](基础特性/[JavaCore]String.md) - 关键词：`不可变`、`字符串常量池`、`intern`、`StringBuilder`、`StringBuffer`
...
- [Java 正则](高级特性/[JavaCore]正则.md) - 关键词：`Pattern`、`Matcher`、`捕获与非捕获`、`零宽断言`、`贪婪与懒惰`
- [Java 编码和加密](高级特性/[JavaCore]编码和加密.md) - 关键词：`Base64`、`消息摘要`、`数字签名`、`对称加密`、`非对称加密`
- [Java 国际化](高级特性/[JavaCore]国际化.md) - 关键词：`Locale`、`ResourceBundle`、`NumberFormat`、`DateFormat`、`MessageFormat`
- [Java SPI](高级特性/[JavaCore]SPI.md) - 关键词：`SPI`、`ServiceLoader`、`ClassLoader`、`扩展点`
- [JavaAgent](高级特性/[JavaCore]Agent.md) - 关键词：`Instrumentation`、`premain`、`ClassFileTransformer`、`字节码增强`、`JVMTI`
