...
>
> **掌握度**栏请自行标记：✅ 已掌握 | ⚠️ 模糊 | ❌ 未掌握

## 📖 内容

### [Java 基础面试一]([JavaCore][面试]基础（一）.md)
...
| Java 基础语法 | `volatile` 关键字的作用和原理？                           | 中等 | ⭐   |   ✅   |
...
| Java 异常     | Java 的 switch 语句在 JDK 14+ 有哪些增强？                | 中等 | ⭐   |   ⚠️   |
| Java 异常     | Java 9 引入的模块化系统（JPMS）有什么用？                 | 中等 | ⭐   |   ❌   |
| Java 异常     | Java 中的 Record（JDK 16+）有什么用？                     | 中等 | ⭐   |   ❌   |
| Java 异常     | Sealed Classes（JDK 17+）有什么用？                       | 中等 | ⭐   |   ❌   |

### [Java 基础面试二]([JavaCore][面试]基础（二）.md)
...
### [Java 并发面试一]([JavaCore][面试]并发（一）.md)
...
### [Java 并发面试二]([JavaCore][面试]并发（二）.md)
...
### [Java 并发面试三]([JavaCore][面试]并发（三）.md)
...
### [Java 虚拟机面试一]([JavaCore][面试]虚拟机（一）.md)
...
| JVM 内存管理 | JVM 的内存区域是如何划分的？                                       | 困难 | ⭐⭐⭐ |   ✅   |
| JVM 内存管理 | JVM 产生 OOM 有哪几种情况？                                        | 困难 | ⭐⭐⭐ |   ✅   |
| JVM 内存管理 | 字符串常量池有什么用？                                             | 简单 | ⭐⭐   |   ✅   |
| JVM 内存管理 | 为什么 Java 8 移除了永久代（PermGen）并引入了元空间（Metaspace）？ | 困难 | ⭐⭐   |   ✅   |
...
### [Java 虚拟机面试二]([JavaCore][面试]虚拟机（二）.md)
...
| 调优     | JDK 内置了哪些工具？                                                          | 简单 | ⭐⭐   |   ✅   |
| 调优     | 常用的 JVM 配置参数有哪些？                                                   | 中等 | ⭐⭐⭐ |   ⚠️   |
| 调优     | 如何在 Java 中进行内存泄漏分析？                                              | 中等 | ⭐⭐⭐ |   ✅   |
| 调优     | 如何对 Java 的垃圾回收进行调优？                                              | 中等 | ⭐⭐   |   ⚠️   |
| 调优     | Java 应用的内存持续性增长，但是监控显示堆内存没有什么变化，可能的原因有哪些？ | 中等 | ⭐⭐   |        |
